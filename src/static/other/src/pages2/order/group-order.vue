  ...
  <view>
    ...
    <view class="product-box">
      ...
      <view class="cut-box">
        ...
        <view class="price-num">2600</view>
      </view>
      <view class="cut-box">
    ...
    <view class="footer order-footer">
      <view class="shop-info">
        <text class="total-text">总计</text>2600
      ...
      <view class="exchange-btn" @tap="payShow=true">确认开团</view>
    </view>
...
export default {
  ...
  methods: {
    ...
    goResult() {
      if (this.isJoiner) {
        this.$uni.navigateTo({
          url: `/pages2/join/join-success`
        });
        this.payShow = false;
        return;
      }
      this.$uni.navigateTo({
        url: `/pages2/order/group-success`
      });
      this.payShow = false;
    }
  }
