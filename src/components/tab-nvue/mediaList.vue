	...
	<view class="view">
		<view
			...
			<view
				...
				<view
					class="view"
					:class="{ 'media-image-right': options.article_type === 2, 'media-image-left': options.article_type === 1 }">
					<text
						class="media-title"
						:class="{ 'media-title2': options.article_type === 1 || options.article_type === 2 }"
						>{{ options.title }}</text
					>
					<view
