  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "3644f53e-7-" + i0 + "," + ("3644f53e-6-" + i0),
        c: common_vendor.t(item.name),
        d: "3644f53e-8-" + i0 + "," + ("3644f53e-6-" + i0),
        e: common_vendor.t(item.address),
        f: "3644f53e-9-" + i0 + "," + ("3644f53e-6-" + i0),
        g: "3644f53e-10-" + i0 + "," + ("3644f53e-6-" + i0),
        h: index,
        i: "3644f53e-6-" + i0 + ",3644f53e-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "3644f53e-0"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/huangchao/works/Web/uni-app/pages/extUI/table/table.vue"]]);
