		...
		function (t, e) {
			...
			t.exports = function t() {
				var e,
					...
					d = !1;
				for (
					"boolean" == typeof f && ((d = f), (f = arguments[1] || {}), (h = 2)), (null == f || ("object" != typeof f && "function" != typeof f)) && (f = {});
					h < p;
					++h
				)
					...
					if (((t = i(!0, {}, t)), "object" == typeof n)) {
						...
						if (o(t.attributes, n.attributes)) {
							if ("string" == typeof t.insert && "string" == typeof n.insert)
								return (
									(this.ops[e - 1] = { insert: n.insert + t.insert }), "object" == typeof t.attributes && (this.ops[e - 1].attributes = t.attributes), this
								);
							if ("number" == typeof t.retain && "number" == typeof n.retain)
								return (
									(this.ops[e - 1] = { retain: n.retain + t.retain }), "object" == typeof t.attributes && (this.ops[e - 1].attributes = t.attributes), this
								);
						}
					}
							...
							[
								{
									...
									value: function (t) {
										...
										return (
											(t = this.sanitize(t)), n.setAttribute("href", t), n.setAttribute("rel", "noopener noreferrer"), n.setAttribute("target", "_blank"), n
										);
									},
								},
								{
