!(function (A) {
	...
	function e(E) {
		...
		var t = (B[E] = { i: E, l: !1, exports: {} });
		return A[E].call(t.exports, t, t.exports, e), (t.l = !0), t.exports;
	}
	(e.m = A),
		(e.c = B),
		(e.d = function (A, B, E) {
			e.o(A, B) || Object.defineProperty(A, B, { enumerable: !0, get: E });
		}),
		(e.r = function (A) {
		...
		(e.t = function (A, B) {
			...
			if ((e.r(E), Object.defineProperty(E, "default", { enumerable: !0, value: A }), 2 & B && "string" != typeof A))
				for (var t in A)
					e.d(
						E,
						t,
	...
	0: function (A, B, e) {
		"use strict";
		function E(A, B, e, E, t, i, o, c, n, g) {
			var Q,
				s = "function" == typeof A ? A.options : A;
			if (n) {
				s.components || (s.components = {});
				var l = Object.prototype.hasOwnProperty;
				for (var w in n) l.call(n, w) && !l.call(s.components, w) && (s.components[w] = n[w]);
			}
			if (
				(g &&
				...
				B && ((s.render = B), (s.staticRenderFns = e), (s._compiled = !0)),
				E && (s.functional = !0),
	...
	10: function (A, B, e) {
		...
		var E,
			t = (E = e(17)) && E.__esModule ? E : { default: E };
		weex
			.requireModule("dom")
			.addRule("fontFace", {
				fontFamily: "uniicons",
	...
	13: function (A, B, e) {
		...
		var o = e(0);
		var c = Object(o.a)(t.default, E.b, E.c, !1, null, "168bca6c", "39eb9647", !1, E.a, void 0);
		(function (A) {
	...
	14: function (A, B, e) {
		...
		Object.defineProperty(B, "__esModule", { value: !0 }),
			(B.log = function (A) {
				for (var B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), E = 1; E < B; E++) e[E - 1] = arguments[E];
				console[A].apply(console, e);
			}),
			(B.default = function () {
				for (var A = arguments.length, B = new Array(A), e = 0; e < A; e++) B[e] = arguments[e];
				var o = B.shift();
				if (t()) return B.push(B.pop().replace("at ", "uni-app:///")), console[o].apply(console, B);
				...
				if (c.length > 1) {
					var g = c.pop();
					(n = c.join("---COMMA---")), 0 === g.indexOf(" at ") ? (n += g) : (n += "---COMMA---" + g);
				} else n = c[0];
				console[o](n);
			});
	},
	...
	16: function (A, B, e) {
		...
		var o = e(0);
		var c = Object(o.a)(t.default, E.b, E.c, !1, null, "041e7dc0", "67d6d51e", !1, E.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	191: function (A, B, e) {
		...
		(function (A) {
			...
			var e = {
				data: function () {
					return { value: "", password: "", placeholderStyle: "color:#499721;font-size:16px", styles: { color: "blue", borderColor: "#499721" } };
				},
				onLoad: function () {},
				onReady: function () {},
				methods: {
					input: function (B) {
						A("log", "\u8f93\u5165\u5185\u5bb9\uff1a", B, " at pages/extUI/easyinput/easyinput.nvue:66");
					},
					iconClick: function (A) {
						uni.showToast({ title: "\u70b9\u51fb\u4e86".concat("prefix" === A ? "\u5de6\u4fa7" : "\u53f3\u4fa7", "\u7684\u56fe\u6807"), icon: "none" });
					},
				},
			};
			B.default = e;
	...
	432: function (A, B, e) {
		...
		var E = { uniSection: e(13).default, uniEasyinput: e(536).default },
			t = function () {
				var A = this,
					B = A.$createElement,
					e = A._self._c || B;
				return e("scroll-view", { staticStyle: { flexDirection: "column" }, attrs: { scrollY: !0, showScrollbar: !0, enableBackToTop: !0, bubble: "true" } }, [
					e(
						...
						[
							...
							e("uni-section", { attrs: { title: "\u9ed8\u8ba4", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
									e("uni-easyinput", {
										attrs: { focus: !0, placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" },
										on: { input: A.input },
										model: {
											value: A.value,
											callback: function (B) {
							...
							e("uni-section", { attrs: { title: "\u53bb\u9664\u7a7a\u683c", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
									e("u-text", { staticClass: ["text"], appendAsTree: !0, attrs: { append: "tree" } }, [
										A._v("\u8f93\u5165\u5185\u5bb9\uff1a" + A._s('"' + A.value + '"')),
									]),
									e("uni-easyinput", {
										attrs: { trim: "all", placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" },
										on: { input: A.input },
										model: {
											value: A.value,
											callback: function (B) {
							...
							e(
								...
								[
									e("uni-easyinput", {
										attrs: { styles: A.styles, placeholderStyle: A.placeholderStyle, placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" },
										on: { input: A.input },
										model: {
											value: A.value,
											callback: function (B) {
							...
							e("uni-section", { attrs: { title: "\u5de6\u56fe\u6807", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
									e("uni-easyinput", {
										attrs: { prefixIcon: "search", placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" },
										on: { iconClick: A.iconClick },
										model: {
											value: A.value,
											callback: function (B) {
												A.value = B;
							...
							e("uni-section", { attrs: { title: "\u53f3\u56fe\u6807", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
									e("uni-easyinput", {
										attrs: { suffixIcon: "search", placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" },
										on: { iconClick: A.iconClick },
										model: {
											value: A.value,
											callback: function (B) {
							...
							e("uni-section", { attrs: { title: "\u7981\u7528", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[e("uni-easyinput", { attrs: { disabled: !0, value: "\u5df2\u7981\u7528", placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" } })],
								1,
							),
							e("uni-section", { attrs: { title: "\u5bc6\u7801\u6846", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
							...
							e("uni-section", { attrs: { title: "\u591a\u884c\u6587\u672c", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
							...
							e("uni-section", { attrs: { title: "\u591a\u884c\u6587\u672c\u81ea\u52a8\u9ad8\u5ea6", type: "line" } }),
							e(
								"view",
								{ staticClass: ["example"] },
								[
									e("uni-easyinput", {
										attrs: { type: "textarea", autoHeight: !0, placeholder: "\u8bf7\u8f93\u5165\u5185\u5bb9" },
										model: {
											value: A.value,
											callback: function (B) {
												A.value = B;
	...
	49: function (A, B, e) {
		...
		var E = {
			...
			methods: {
				...
				getForm: function () {
					for (var A = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "uniForms", B = this.$parent, e = B.$options.name; e !== A; ) {
				...
				onInput: function (A) {
					...
					this.trim && ("boolean" == typeof this.trim && this.trim && (B = this.trimStr(B)), "string" == typeof this.trim && (B = this.trimStr(B, this.trim))),
				...
				trimStr: function (A) {
					var B = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "both";
					return "both" === B
						? A.trim()
						: "left" === B
						? A.trimLeft()
	...
	536: function (A, B, e) {
		...
		var o = e(0);
		var c = Object(o.a)(t.default, E.b, E.c, !1, null, "4ecfd335", "6e328766", !1, E.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(e(63).default, this.options.style) : Object.assign(this.options.style, e(63).default);
		}).call(c),
			(B.default = c.exports);
	},
	537: function (A, B, e) {
		"use strict";
		(function (A) {
			Object.defineProperty(B, "__esModule", { value: !0 }), (B.throttle = B.debounce = void 0);
	...
	663: function (A, B, e) {
		...
		"undefined" == typeof Promise ||
			...
			(E.default.route = "pages/extUI/easyinput/easyinput"),
			(E.default.el = "#root"),
			new Vue(E.default);
	},
	7: function (A, B, e) {
	...
	82: function (A, B, e) {
		...
		var E = e(432),
			t = e(190),
			i = e(0);
		var o = Object(i.a)(t.default, E.b, E.c, !1, null, null, "35725542", !1, E.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(e(563).default, this.options.style) : Object.assign(this.options.style, e(563).default);
		}).call(o),
			(B.default = o.exports);
	},
	9: function (A, B, e) {
