!(function (A) {
	...
	function B(e) {
		...
		return A[e].call(i.exports, i, i.exports, B), (i.l = !0), i.exports;
	}
	(B.m = A),
		(B.c = t),
		(B.d = function (A, t, e) {
			B.o(A, t) || Object.defineProperty(A, t, { enumerable: !0, get: e });
		}),
		(B.r = function (A) {
		...
		(B.t = function (A, t) {
			if ((1 & t && (A = B(A)), 8 & t)) return A;
			if (4 & t && "object" == typeof A && A && A.__esModule) return A;
			var e = Object.create(null);
			if ((B.r(e), Object.defineProperty(e, "default", { enumerable: !0, value: A }), 2 & t && "string" != typeof A))
				for (var i in A)
					B.d(
						e,
						i,
	...
	0: function (A, t, B) {
		"use strict";
		function e(A, t, B, e, i, E, g, c, n, o) {
			var Q,
				a = "function" == typeof A ? A.options : A;
			if (n) {
				a.components || (a.components = {});
				var s = Object.prototype.hasOwnProperty;
				for (var l in n) s.call(n, l) && !s.call(a.components, l) && (a.components[l] = n[l]);
			}
			if (
				(o &&
					...
					(a.mixins || (a.mixins = [])).push(o)),
				t && ((a.render = t), (a.staticRenderFns = B), (a._compiled = !0)),
				e && (a.functional = !0),
				E && (a._scopeId = "data-v-" + E),
				g
					? ((Q = function (A) {
							(A = A || (this.$vnode && this.$vnode.ssrContext) || (this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext)) ||
								...
								i && i.call(this, A),
								A && A._registeredComponents && A._registeredComponents.add(g);
					  }),
					  (a._ssrRegister = Q))
					: i &&
					  (Q = c
				...
				if (a.functional) {
					a._injectStyles = Q;
					var r = a.render;
					a.render = function (A, t) {
						return Q.call(t), r(A, t);
					};
				} else {
					var w = a.beforeCreate;
					a.beforeCreate = w ? [].concat(w, Q) : [Q];
				}
			return { exports: A, options: a };
		}
		B.d(t, "a", function () {
			return e;
		});
	...
	10: function (A, t, B) {
		...
		var e,
			i = (e = B(17)) && e.__esModule ? e : { default: e };
		weex
			.requireModule("dom")
			.addRule("fontFace", {
				fontFamily: "uniicons",
	...
	13: function (A, t, B) {
		...
		var g = B(0);
		var c = Object(g.a)(i.default, e.b, e.c, !1, null, "168bca6c", "39eb9647", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				...
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(B(8).default, this.options.style) : Object.assign(this.options.style, B(8).default);
		}).call(c),
			(t.default = c.exports);
	},
	14: function (A, t, B) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t.log = function (A) {
				for (var t = arguments.length, B = new Array(t > 1 ? t - 1 : 0), e = 1; e < t; e++) B[e - 1] = arguments[e];
				console[A].apply(console, B);
			}),
			(t.default = function () {
				for (var A = arguments.length, t = new Array(A), B = 0; B < A; B++) t[B] = arguments[B];
				var g = t.shift();
				if (i()) return t.push(t.pop().replace("at ", "uni-app:///")), console[g].apply(console, t);
				var c = t.map(function (A) {
						var t = Object.prototype.toString.call(A).toLowerCase();
						if ("[object object]" === t || "[object array]" === t)
							try {
								A = "---BEGIN:JSON---" + JSON.stringify(A, E) + "---END:JSON---";
							} catch (B) {
								A = t;
							}
							...
							var B = e(A).toUpperCase();
							A = "NUMBER" === B || "BOOLEAN" === B ? "---BEGIN:" + B + "---" + A + "---END:" + B + "---" : String(A);
						}
						return A;
					}),
					n = "";
				if (c.length > 1) {
					var o = c.pop();
					(n = c.join("---COMMA---")), 0 === o.indexOf(" at ") ? (n += o) : (n += "---COMMA---" + o);
				} else n = c[0];
				console[g](n);
			});
	},
	...
	16: function (A, t, B) {
		...
		var g = B(0);
		var c = Object(g.a)(i.default, e.b, e.c, !1, null, "041e7dc0", "67d6d51e", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(B(15).default, this.options.style) : Object.assign(this.options.style, B(15).default);
		}).call(c),
			(t.default = c.exports);
	},
	17: function (A, t, B) {
		...
		(function (A) {
			...
			var B = {
				...
				props: {
					...
					avatarCircle: { type: Boolean, default: !1 },
				...
				computed: {
					isSingle: function () {
						return "dot" === this.badgeText ? "uni-badge--dot" : this.badgeText.toString().length > 1 ? "uni-badge--complex" : "uni-badge--single";
					},
					computedAvatar: function () {
						return this.avatarList.length > 4
							? ((this.imageWidth = 13.95), "avatarItem--3")
							: this.avatarList.length > 1
							? ((this.imageWidth = 21.15), "avatarItem--2")
							: ((this.imageWidth = 45), "avatarItem--1");
					},
				},
				data: function () {
					return { isFirstChild: !1, border: !0, imageWidth: 50 };
				},
				mounted: function () {
					(this.list = this.getForm()),
						this.list && (this.list.firstChildAppend || ((this.list.firstChildAppend = !0), (this.isFirstChild = !0)), (this.border = this.list.border));
				},
				methods: {
					getForm: function () {
						for (var A = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "uniList", t = this.$parent, B = t.$options.name; B !== A; ) {
					...
					onClick: function () {
						"" === this.to ? (this.clickable || this.link) && this.$emit("click", { data: {} }) : this.openPage();
					},
					openPage: function () {
					...
					pageApi: function (t) {
						...
						uni[t]({
							...
							fail: function (t) {
								B.$emit("click", { data: t }), A("error", t.errMsg, " at components/uni-list-chat/uni-list-chat.vue:211");
							},
						});
					},
				},
		...
		A.exports = {
			".uni-list-chat": {
				"": {
					...
					flexDirection: ["column", 0, 0, 16],
					justifyContent: ["space-between", 0, 0, 16],
					backgroundColor: ["#ffffff", 0, 0, 16],
				},
			},
			".uni-list-chat--hover": { "": { backgroundColor: ["#f5f5f5", 0, 0, 17] } },
			".uni-list--border": {
				"": {
					position: ["relative", 0, 0, 18],
					marginLeft: ["15", 0, 0, 18],
					borderTopColor: ["#e5e5e5", 0, 0, 18],
					borderTopStyle: ["solid", 0, 0, 18],
					borderTopWidth: ["0.5", 0, 0, 18],
				},
			},
			".uni-list-chat--first": { "": { borderTopWidth: ["0", 0, 0, 19] } },
			".uni-ellipsis": { "": { lines: [1, 0, 0, 20] } },
			".uni-ellipsis-2": { "": { lines: [2, 0, 0, 21] } },
			".uni-list-chat__container": {
				"": {
					position: ["relative", 0, 0, 22],
					flexDirection: ["row", 0, 0, 22],
					flex: [1, 0, 0, 22],
					paddingTop: ["10", 0, 0, 22],
					paddingRight: ["15", 0, 0, 22],
					paddingBottom: ["10", 0, 0, 22],
					paddingLeft: ["15", 0, 0, 22],
					overflow: ["hidden", 0, 0, 22],
				},
			},
			".uni-list-chat__header-warp": { "": { position: ["relative", 0, 0, 23] } },
			".uni-list-chat__header": {
				"": {
					flexDirection: ["row", 0, 0, 24],
					justifyContent: ["center", 0, 0, 24],
					alignItems: ["center", 0, 0, 24],
					flexWrap: ["wrap-reverse", 0, 0, 24],
					width: ["50", 0, 0, 24],
					height: ["50", 0, 0, 24],
					borderRadius: ["5", 0, 0, 24],
					borderColor: ["#eeeeee", 0, 0, 24],
					borderWidth: ["1", 0, 0, 24],
					borderStyle: ["solid", 0, 0, 24],
					overflow: ["hidden", 0, 0, 24],
				},
			},
			".uni-list-chat__header-box": {
				"": { width: ["50", 0, 0, 25], height: ["50", 0, 0, 25], overflow: ["hidden", 0, 0, 25], borderRadius: ["2", 0, 0, 25] },
			},
			".uni-list-chat__header-image": {
				"": {
					marginTop: ["1", 0, 0, 26],
					marginRight: ["1", 0, 0, 26],
					marginBottom: ["1", 0, 0, 26],
					marginLeft: ["1", 0, 0, 26],
					width: ["50", 0, 0, 26],
					height: ["50", 0, 0, 26],
				},
			},
			".header--circle": { "": { borderRadius: [50, 0, 0, 27] } },
			".uni-list-chat__content": {
				"": {
					flexDirection: ["row", 0, 0, 28],
					flex: [1, 0, 0, 28],
					overflow: ["hidden", 0, 0, 28],
					paddingTop: ["2", 0, 0, 28],
					paddingRight: [0, 0, 0, 28],
					paddingBottom: ["2", 0, 0, 28],
					paddingLeft: [0, 0, 0, 28],
				},
			},
			".uni-list-chat__content-main": {
				"": {
					flexDirection: ["column", 0, 0, 29],
					justifyContent: ["space-between", 0, 0, 29],
					paddingLeft: ["10", 0, 0, 29],
					flex: [1, 0, 0, 29],
					overflow: ["hidden", 0, 0, 29],
				},
			},
			".uni-list-chat__content-title": {
				"": { fontSize: ["16", 0, 0, 30], color: ["#3b4144", 0, 0, 30], fontWeight: ["normal", 0, 0, 30], overflow: ["hidden", 0, 0, 30] },
			},
			".uni-list-chat__content-note": {
				"": {
					...
					color: ["#999999", 0, 0, 31],
					fontSize: ["12", 0, 0, 31],
					fontWeight: ["normal", 0, 0, 31],
					overflow: ["hidden", 0, 0, 31],
				},
			},
			".uni-list-chat__content-extra": {
				"": {
					flexDirection: ["column", 0, 0, 32],
					justifyContent: ["space-between", 0, 0, 32],
					alignItems: ["flex-end", 0, 0, 32],
					marginLeft: ["5", 0, 0, 32],
				},
			},
			".uni-list-chat__content-extra-text": {
				"": { color: ["#999999", 0, 0, 33], fontSize: ["12", 0, 0, 33], fontWeight: ["normal", 0, 0, 33], overflow: ["hidden", 0, 0, 33] },
			},
			".uni-list-chat__badge-pos": { "": { position: ["absolute", 0, 0, 34], left: ["55", 0, 0, 34], top: ["3", 0, 0, 34] } },
			".uni-list-chat__badge": {
				"": { justifyContent: ["center", 0, 0, 35], alignItems: ["center", 0, 0, 35], borderRadius: ["100", 0, 0, 35], backgroundColor: ["#ff5a5f", 0, 0, 35] },
			},
			".uni-list-chat__badge-text": { "": { color: ["#ffffff", 0, 0, 36], fontSize: ["12", 0, 0, 36] } },
			".uni-badge--single": { "": { width: ["18", 0, 0, 37], height: ["18", 0, 0, 37] } },
			".uni-badge--complex": {
				"": {
					left: ["50", 0, 0, 38],
					height: ["18", 0, 0, 38],
					paddingTop: [0, 0, 0, 38],
					paddingRight: ["6", 0, 0, 38],
					paddingBottom: [0, 0, 0, 38],
					paddingLeft: ["6", 0, 0, 38],
				},
			},
			".uni-badge--dot": {
				"": {
					...
					height: ["10", 0, 0, 39],
					paddingTop: [0, 0, 0, 39],
					paddingRight: [0, 0, 0, 39],
					paddingBottom: [0, 0, 0, 39],
					paddingLeft: [0, 0, 0, 39],
				},
			},
			".uni-list-chat--right": { "": { left: [0, 0, 0, 40] } },
			"@VERSION": 2,
		};
	},
	207: function (A, t, B) {
			...
			var B = {
				...
				data: function () {
					return {
						...
						listData: [],
						avatarList: [{ url: "/static/logo.png" }, { url: "/static/logo.png" }, { url: "/static/logo.png" }],
					};
				},
				onLoad: function () {
					this.getList();
				...
				methods: {
					onClick: function () {
						uni.showToast({ title: "\u5217\u8868\u88ab\u70b9\u51fb" });
					},
					avatar: function (A) {
						var t = [];
						return (
							this.avatarList.forEach(function (B, e) {
								e < A && t.push(B);
							}),
							t
						);
					...
					getList: function () {
						...
						uni.request({
							...
							data: { column: "id,post_id,title,author_name,cover,published_at" },
							success: function (A) {
								if (200 == A.statusCode) {
									var B = t.setTime(A.data);
									(B = t.reload ? B : t.listData.concat(B)).map(function (A) {
										return (A.text = Math.floor(-19 * Math.random() + 20)), A;
									}),
										(t.listData = t.getRandomArrayElements(B, 3));
								}
							},
							fail: function (t, B) {
								A("log", "fail" + JSON.stringify(t), " at pages/extUI/list/chat.nvue:93");
							},
						});
					},
					getRandomArrayElements: function (A, t) {
						for (var B, e, i = A.slice(0), E = A.length, g = E - t; E-- > g; ) (B = i[(e = Math.floor((E + 1) * Math.random()))]), (i[e] = i[E]), (i[E] = B);
						return i.slice(g);
					},
					setTime: function (A) {
						var t = this,
						...
						return (
							A.forEach(function (A) {
								B.push({ author_name: A.author_name, cover: A.cover, id: A.id, post_id: A.post_id, published_at: t.format(A.published_at), title: A.title });
							}),
							B
						);
					},
					format: function (A) {
						var t = this.parse(A),
							B = Date.now() - t.getTime();
						if (B < this.UNITS["\u5929"]) return this.humanize(B);
						var e = function (A) {
							return A < 10 ? "0" + A : A;
						};
	...
	209: function (A, t) {
		A.exports = {
			...
			".chat-custom-right": {
				"": { flex: [1, 0, 0, 9], flexDirection: ["column", 0, 0, 9], justifyContent: ["space-between", 0, 0, 9], alignItems: ["flex-end", 0, 0, 9] },
			},
			".chat-custom-text": { "": { fontSize: ["12", 0, 0, 10], color: ["#999999", 0, 0, 10] } },
			"@VERSION": 2,
		};
	},
	22: function (A, t, B) {
	...
	24: function (A, t) {
		A.exports = {
			".uni-list": { "": { backgroundColor: ["#ffffff", 0, 0, 0], position: ["relative", 0, 0, 0], flexDirection: ["column", 0, 0, 0] } },
			".uni-list--border": {
				"": {
					position: ["relative", 0, 0, 1],
					borderTopColor: ["#e5e5e5", 0, 0, 1],
					borderTopStyle: ["solid", 0, 0, 1],
					borderTopWidth: ["0.5", 0, 0, 1],
					borderBottomColor: ["#e5e5e5", 0, 0, 1],
					borderBottomStyle: ["solid", 0, 0, 1],
					borderBottomWidth: ["0.5", 0, 0, 1],
					zIndex: [-1, 0, 0, 1],
				},
			},
			"@VERSION": 2,
	...
	25: function (A, t, B) {
		...
		var e = function () {
				...
				return (this._self._c || A)(
					"list",
					{ staticClass: ["uni-list"], class: { "uni-list--border": this.border }, attrs: { enableBackToTop: this.enableBackToTop, loadmoreoffset: "15" } },
					[this._t("default")],
					2,
				);
			},
	...
	436: function (A, t, B) {
		...
		var e = { uniSection: B(13).default, uniList: B(46).default, uniListChat: B(670).default, uniIcons: B(16).default },
			i = function () {
				var A = this,
					t = A.$createElement,
					B = A._self._c || t;
				return B("scroll-view", { staticStyle: { flexDirection: "column" }, attrs: { scrollY: !0, showScrollbar: !0, enableBackToTop: !0, bubble: "true" } }, [
					B(
						"view",
						[
							B("u-text", { staticClass: ["example-info"], appendAsTree: !0, attrs: { append: "tree" } }, [
								A._v("\u6b64\u793a\u4f8b\u5c55\u793a\u4e86\u804a\u5929\u5217\u8868\u7684\u4f7f\u7528\u573a\u666f"),
							]),
							B("uni-section", { attrs: { title: "\u5706\u5934\u50cf\u4e14\u4e0d\u663e\u793a\u5206\u5272\u7ebf", type: "line" } }),
							B(
								"uni-list",
								{ attrs: { border: !1 } },
								A._l(A.listData, function (A) {
									return B("uni-list-chat", {
										key: A.id,
										attrs: { avatarCircle: !0, title: A.author_name, avatar: A.cover, note: A.title, time: A.published_at, clickable: !1 },
									});
								}),
								1,
							),
							B("uni-section", { attrs: { title: "\u5e26\u5706\u70b9", type: "line" } }),
							B(
								"uni-list",
								A._l(A.listData, function (A) {
									return B("uni-list-chat", {
							...
							B("uni-section", { attrs: { title: "\u81ea\u5b9a\u4e49\u53f3\u4fa7\u5185\u5bb9", type: "line" } }),
							B(
								"uni-list",
								A._l(A.listData, function (t) {
									return B(
										"uni-list-chat",
										{ key: t.id, attrs: { title: t.author_name, avatar: t.cover, note: t.title, badgePositon: "left", badgeText: t.text } },
										[
											B(
												"view",
												{ staticClass: ["chat-custom-right"] },
												[
													B("u-text", { staticClass: ["chat-custom-text"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v("\u521a\u521a")]),
													B("uni-icons", { attrs: { type: "star-filled", color: "#999", size: "18" } }),
												],
												1,
											),
										],
							...
							B("uni-section", { attrs: { title: "\u5e26\u901a\u77e5\u89d2\u6807\u7684\u5355\u5934\u50cf\u804a\u5929\u5217\u8868", type: "line" } }),
							B(
								"uni-list",
								A._l(A.listData, function (t) {
									return B("uni-list-chat", {
										key: t.id,
										attrs: { title: t.author_name, avatar: t.cover, note: t.title, time: t.published_at, clickable: !0, badgeText: t.text },
										on: { click: A.onClick },
									});
								}),
								1,
							),
							B("uni-section", { attrs: { title: "\u5e26\u901a\u77e5\u89d2\u6807\u7684\u591a\u5934\u50cf\u804a\u5929\u5217\u8868", type: "line" } }),
							B(
								"uni-list",
								A._l(A.listData, function (t, e) {
									return B("uni-list-chat", {
										key: t.id,
										attrs: {
											title: t.author_name,
	...
	46: function (A, t, B) {
		...
		var g = B(0);
		var c = Object(g.a)(i.default, e.b, e.c, !1, null, "34ed0c8e", "c74315e2", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(B(34).default, this.options.style) : Object.assign(this.options.style, B(34).default);
		}).call(c),
			(t.default = c.exports);
	},
	5: function (A, t, B) {
		...
		var e = function () {
				...
				return B(
					...
					[
						A.type ? B("view", { staticClass: ["uni-section__head"] }, [B("view", { staticClass: ["uni-section__head-tag"], class: A.type })]) : A._e(),
						B("view", { staticClass: ["uni-section__content"] }, [
							B("u-text", { staticClass: ["uni-section__content-title"], class: { distraction: !A.subTitle }, appendAsTree: !0, attrs: { append: "tree" } }, [
								A._v(A._s(A.title)),
							]),
							A.subTitle
								? B("u-text", { staticClass: ["uni-section__content-sub"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.subTitle))])
								: A._e(),
						]),
						A._t("default"),
					],
	...
	514: function (A, t, B) {
		...
		var e = function () {
				var A = this,
					t = A.$createElement,
					B = A._self._c || t;
				return B("cell", { appendAsTree: !0, attrs: { append: "tree" } }, [
					B("view", { staticClass: ["uni-list-chat"], attrs: { hoverClass: A.clickable || A.link ? "uni-list-chat--hover" : "" }, on: { click: A.onClick } }, [
						B("view", { class: { "uni-list--border": A.border, "uni-list-chat--first": A.isFirstChild } }),
						B("view", { staticClass: ["uni-list-chat__container"] }, [
							B("view", { staticClass: ["uni-list-chat__header-warp"] }, [
								A.avatarCircle || 0 === A.avatarList.length
									? B(
											"view",
											{ staticClass: ["uni-list-chat__header"], class: { "header--circle": A.avatarCircle } },
											[B("u-image", { staticClass: ["uni-list-chat__header-image"], attrs: { src: A.avatar, mode: "aspectFill" } })],
											1,
									  )
									: B(
											"view",
											{ staticClass: ["uni-list-chat__header"] },
											A._l(A.avatarList, function (t, e) {
												return B(
													"view",
													{
														key: e,
														staticClass: ["uni-list-chat__header-box"],
														class: A.computedAvatar,
														style: { width: A.imageWidth + "px", height: A.imageWidth + "px" },
													},
													[
														B("u-image", {
															staticClass: ["uni-list-chat__header-image"],
															style: { width: A.imageWidth + "px", height: A.imageWidth + "px" },
															attrs: { src: t.url, mode: "aspectFill" },
														}),
													],
													1,
												);
							...
							A.badgeText && "left" === A.badgePositon
								? B("view", { staticClass: ["uni-list-chat__badge", "uni-list-chat__badge-pos"], class: [A.isSingle] }, [
										B("u-text", { staticClass: ["uni-list-chat__badge-text"], appendAsTree: !0, attrs: { append: "tree" } }, [
											A._v(A._s("dot" === A.badgeText ? "" : A.badgeText)),
										]),
								  ])
								: A._e(),
							B("view", { staticClass: ["uni-list-chat__content"] }, [
								B("view", { staticClass: ["uni-list-chat__content-main"] }, [
									B("u-text", { staticClass: ["uni-list-chat__content-title", "uni-ellipsis"], appendAsTree: !0, attrs: { append: "tree" } }, [
										A._v(A._s(A.title)),
									]),
									B("u-text", { staticClass: ["uni-list-chat__content-note", "uni-ellipsis"], appendAsTree: !0, attrs: { append: "tree" } }, [
										A._v(A._s(A.note)),
									]),
								]),
								B(
									...
									[
										A._t("default", [
											B("u-text", { staticClass: ["uni-list-chat__content-extra-text"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.time))]),
											A.badgeText && "right" === A.badgePositon
												? B("view", { staticClass: ["uni-list-chat__badge"], class: [A.isSingle, "right" === A.badgePositon ? "uni-list-chat--right" : ""] }, [
														B("u-text", { staticClass: ["uni-list-chat__badge-text"], appendAsTree: !0, attrs: { append: "tree" } }, [
															A._v(A._s("dot" === A.badgeText ? "" : A.badgeText)),
														]),
												  ])
	...
	6: function (A, t, B) {
		(Vue.prototype.__$appStyle__ = {}), Vue.prototype.__merge_style && Vue.prototype.__merge_style(B(7).default, Vue.prototype.__$appStyle__);
	},
	669: function (A, t, B) {
		"use strict";
		B.r(t);
		...
		"undefined" == typeof Promise ||
			...
			(e.default.mpType = "page"),
			(e.default.route = "pages/extUI/list/chat"),
			(e.default.el = "#root"),
			new Vue(e.default);
	},
	670: function (A, t, B) {
		...
		var g = B(0);
		var c = Object(g.a)(i.default, e.b, e.c, !1, null, "34344b98", "5c81e16a", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(B(567).default, this.options.style) : Object.assign(this.options.style, B(567).default);
		}).call(c),
			(t.default = c.exports);
	},
	7: function (A, t, B) {
	...
	85: function (A, t, B) {
		...
		var e = B(436),
			i = B(207),
			E = B(0);
		var g = Object(E.a)(i.default, e.b, e.c, !1, null, null, "52ead4e0", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(B(568).default, this.options.style) : Object.assign(this.options.style, B(568).default);
		}).call(g),
			(t.default = g.exports);
	},
	9: function (A, t, B) {
