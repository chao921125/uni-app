!(function (A) {
	...
	function e(t) {
		...
		return A[t].call(E.exports, E, E.exports, e), (E.l = !0), E.exports;
	}
	(e.m = A),
		(e.c = B),
		(e.d = function (A, B, t) {
			e.o(A, B) || Object.defineProperty(A, B, { enumerable: !0, get: t });
		}),
		(e.r = function (A) {
		...
		(e.t = function (A, B) {
			...
			if ((e.r(t), Object.defineProperty(t, "default", { enumerable: !0, value: A }), 2 & B && "string" != typeof A))
				for (var E in A)
					e.d(
						t,
						E,
	...
	0: function (A, B, e) {
		"use strict";
		function t(A, B, e, t, E, i, g, o, c, n) {
			var Q,
				l = "function" == typeof A ? A.options : A;
			if (c) {
				l.components || (l.components = {});
				var s = Object.prototype.hasOwnProperty;
				for (var w in c) s.call(c, w) && !s.call(l.components, w) && (l.components[w] = c[w]);
			}
			if (
				(n &&
					((n.beforeCreate || (n.beforeCreate = [])).unshift(function () {
						this[n.__module] = this;
					}),
					(l.mixins || (l.mixins = [])).push(n)),
				B && ((l.render = B), (l.staticRenderFns = e), (l._compiled = !0)),
				t && (l.functional = !0),
				...
				if (l.functional) {
					...
					l.render = function (A, B) {
						return Q.call(B), a(A, B);
					};
				} else {
					var r = l.beforeCreate;
					l.beforeCreate = r ? [].concat(r, Q) : [Q];
				}
			return { exports: A, options: l };
		}
		e.d(B, "a", function () {
			return t;
		});
	...
	10: function (A, B, e) {
		...
		var t,
			E = (t = e(17)) && t.__esModule ? t : { default: t };
		weex
			.requireModule("dom")
			.addRule("fontFace", {
				fontFamily: "uniicons",
	...
	123: function (A, B, e) {
		...
		function g(A, B, e) {
			return B in A ? Object.defineProperty(A, B, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : (A[B] = e), A;
		}
		A.exports = {
			components: { uniList: t.default, uniListItem: E.default },
			data: function () {
				var A;
				return (
					g(
			...
			methods: {
				...
				enableThreeD: function (A) {
					this.enable3D = A.value;
				},
				changeShowCompass: function (A) {
					this.showCompass = A.value;
				},
				changeEnableOverlooking: function (A) {
					this.enableOverlooking = A.value;
				},
				changeEnableZoom: function (A) {
					this.enableZoom = A.value;
				},
				changeEnableScroll: function (A) {
					this.enableScroll = A.value;
				},
				changeEnableRotate: function (A) {
					this.enableRotate = A.value;
				},
				changeEnableSatellite: function (A) {
					this.enableSatellite = A.value;
				},
				changeEnableTraffic: function (A) {
					this.enableTraffic = A.value;
				},
			},
		};
	},
	...
	14: function (A, B, e) {
		...
		Object.defineProperty(B, "__esModule", { value: !0 }),
			(B.log = function (A) {
				for (var B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), t = 1; t < B; t++) e[t - 1] = arguments[t];
				console[A].apply(console, e);
			}),
			(B.default = function () {
				for (var A = arguments.length, B = new Array(A), e = 0; e < A; e++) B[e] = arguments[e];
				var g = B.shift();
				if (E()) return B.push(B.pop().replace("at ", "uni-app:///")), console[g].apply(console, B);
				var o = B.map(function (A) {
						var B = Object.prototype.toString.call(A).toLowerCase();
						if ("[object object]" === B || "[object array]" === B)
							try {
				...
				if (o.length > 1) {
					var n = o.pop();
					(c = o.join("---COMMA---")), 0 === n.indexOf(" at ") ? (c += n) : (c += "---COMMA---" + n);
				} else c = o[0];
				console[g](c);
			});
	},
	...
	16: function (A, B, e) {
		...
		var g = e(0);
		var o = Object(g.a)(E.default, t.b, t.c, !1, null, "041e7dc0", "67d6d51e", !1, t.a, void 0);
		(function (A) {
	...
	27: function (A, B, e) {
		...
		(function (A) {
			...
			var e = {
				...
				methods: {
					getForm: function () {
						for (var A = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "uniList", B = this.$parent, e = B.$options.name; e !== A; ) {
					...
					pageApi: function (B) {
						...
						uni[B]({
							...
							fail: function (B) {
								e.$emit("click", { data: B }), A("error", B.errMsg, " at components/uni-list-item/uni-list-item.vue:228");
							},
						});
					},
				},
	...
	31: function (A, B, e) {
		...
		var t = { uniIcons: e(16).default, uniBadge: e(43).default },
			E = function () {
				var A = this,
					B = A.$createElement,
					e = A._self._c || B;
	...
	43: function (A, B, e) {
		...
		var g = e(0);
		var o = Object(g.a)(E.default, t.b, t.c, !1, null, "6ee486c2", "327cd37a", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	46: function (A, B, e) {
		...
		var g = e(0);
		var o = Object(g.a)(E.default, t.b, t.c, !1, null, "34ed0c8e", "c74315e2", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	467: function (A, B, e) {
		...
		var t = { uniList: e(46).default, uniListItem: e(55).default },
			E = function () {
				var A = this,
					B = A.$createElement,
					e = A._self._c || B;
						...
						[
							e("map", {
								...
								attrs: {
									...
									rotate: A.rotate,
									skew: A.skew,
									showCompass: A.showCompass,
									enableOverlooking: A.enableOverlooking,
									enableZoom: A.enableZoom,
									enableScroll: A.enableScroll,
									enableRotate: A.enableRotate,
									enableSatellite: A.enableSatellite,
									enableTraffic: A.enableTraffic,
									markers: A.markers,
									polyline: A.polyline,
									circles: A.circles,
									polygons: A.polygons,
									includePoints: A.includePoints,
								},
							}),
							e("view", { staticClass: ["line"] }),
							e(
								"uni-list",
								{ staticClass: ["scrollview"] },
								[
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enable3D, title: "\u663e\u793a3D\u697c\u5757" },
										on: { switchChange: A.enableThreeD },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.showCompass, title: "\u663e\u793a\u6307\u5357\u9488" },
										on: { switchChange: A.changeShowCompass },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enableOverlooking, title: "\u5f00\u542f\u4fef\u89c6" },
										on: { switchChange: A.changeEnableOverlooking },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enableZoom, title: "\u662f\u5426\u652f\u6301\u7f29\u653e" },
										on: { switchChange: A.changeEnableZoom },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enableScroll, title: "\u662f\u5426\u652f\u6301\u62d6\u52a8" },
										on: { switchChange: A.changeEnableScroll },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enableRotate, title: "\u662f\u5426\u652f\u6301\u65cb\u8f6c" },
										on: { switchChange: A.changeEnableRotate },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enableSatellite, title: "\u662f\u5426\u5f00\u542f\u536b\u661f\u56fe" },
										on: { switchChange: A.changeEnableSatellite },
									}),
									e("uni-list-item", {
										attrs: { showArrow: !1, showSwitch: !0, switchChecked: A.enableTraffic, title: "\u662f\u5426\u5f00\u542f\u5b9e\u65f6\u8def\u51b5" },
										on: { switchChange: A.changeEnableTraffic },
									}),
								],
								1,
							),
	...
	55: function (A, B, e) {
		...
		var g = e(0);
		var o = Object(g.a)(E.default, t.b, t.c, !1, null, null, "7f6e3081", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	640: function (A, B, e) {
		...
		"undefined" == typeof Promise ||
			...
			(t.default.mpType = "page"),
			(t.default.route = "pages/component/map/map"),
			(t.default.el = "#root"),
			new Vue(t.default);
	},
	65: function (A, B, e) {
		...
		var t = e(467),
			E = e(122),
			i = e(0);
		var g = Object(i.a)(E.default, t.b, t.c, !1, null, null, "6c6b2a92", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(e(540).default, this.options.style) : Object.assign(this.options.style, e(540).default);
		}).call(g),
			(B.default = g.exports);
	},
	7: function (A, B, e) {
