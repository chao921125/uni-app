!(function (A) {
	...
	function E(e) {
		...
		var c = (B[e] = { i: e, l: !1, exports: {} });
		return A[e].call(c.exports, c, c.exports, E), (c.l = !0), c.exports;
	}
	(E.m = A),
		(E.c = B),
		(E.d = function (A, B, e) {
	...
	0: function (A, B, E) {
		"use strict";
		function e(A, B, E, e, c, Q, g, t, i, o) {
			var n,
				w = "function" == typeof A ? A.options : A;
			if (i) {
				w.components || (w.components = {});
				var s = Object.prototype.hasOwnProperty;
				for (var a in i) s.call(i, a) && !s.call(w.components, a) && (w.components[a] = i[a]);
			}
			if (
				(o &&
				...
				if (w.functional) {
					...
					w.render = function (A, B) {
						return n.call(B), l(A, B);
					};
				} else {
					var r = w.beforeCreate;
					w.beforeCreate = r ? [].concat(r, n) : [n];
				}
	...
	10: function (A, B, E) {
		...
		var e,
			c = (e = E(17)) && e.__esModule ? e : { default: e };
		weex
			.requireModule("dom")
			.addRule("fontFace", {
				fontFamily: "uniicons",
	...
	13: function (A, B, E) {
		...
		var g = E(0);
		var t = Object(g.a)(c.default, e.b, e.c, !1, null, "168bca6c", "39eb9647", !1, e.a, void 0);
		(function (A) {
	...
	14: function (A, B, E) {
		...
		Object.defineProperty(B, "__esModule", { value: !0 }),
			...
			(B.default = function () {
				...
				var g = B.shift();
				if (c()) return B.push(B.pop().replace("at ", "uni-app:///")), console[g].apply(console, B);
				var t = B.map(function (A) {
						var B = Object.prototype.toString.call(A).toLowerCase();
						if ("[object object]" === B || "[object array]" === B)
							try {
								A = "---BEGIN:JSON---" + JSON.stringify(A, Q) + "---END:JSON---";
							} catch (E) {
								A = B;
							}
				...
				if (t.length > 1) {
					var o = t.pop();
					(i = t.join("---COMMA---")), 0 === o.indexOf(" at ") ? (i += o) : (i += "---COMMA---" + o);
				} else i = t[0];
				console[g](i);
			});
	},
	...
	16: function (A, B, E) {
		...
		var g = E(0);
		var t = Object(g.a)(c.default, e.b, e.c, !1, null, "041e7dc0", "67d6d51e", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
		...
		var e = {
			...
			watch: {
				value: {
					immediate: !0,
					handler: function (A) {
						(this.searchVal = A), A && (this.show = !0);
					},
				},
				focus: {
					immediate: !0,
			...
			methods: {
				...
				clear: function () {
					this.$emit("clear", { value: this.searchVal }), (this.searchVal = "");
				},
				cancel: function () {
					this.$emit("cancel", { value: this.searchVal }), (this.searchVal = ""), (this.show = !1), (this.showSync = !1), plus.key.hideSoftKeybord();
				},
				confirm: function () {
					plus.key.hideSoftKeybord(), this.$emit("confirm", { value: this.searchVal });
				},
				blur: function () {
					plus.key.hideSoftKeybord(), this.$emit("blur", { value: this.searchVal });
				},
				emitFocus: function (A) {
					this.$emit("focus", A.detail);
				},
			},
		};
		B.default = e;
		...
		A.exports = {
			".uni-searchbar": {
				"": {
					...
					paddingBottom: ["8", 0, 0, 0],
					paddingLeft: ["8", 0, 0, 0],
				},
			},
			".uni-searchbar__box": {
				"": {
					overflow: ["hidden", 0, 0, 1],
					...
					height: ["36", 0, 0, 1],
					paddingTop: ["5", 0, 0, 1],
					paddingRight: ["8", 0, 0, 1],
					paddingBottom: ["5", 0, 0, 1],
					paddingLeft: ["0", 0, 0, 1],
			...
			".uni-searchbar__box-search-input": { "": { flex: [1, 0, 0, 3], fontSize: ["14", 0, 0, 3], color: ["#333333", 0, 0, 3] } },
			".uni-searchbar__box-icon-clear": { "": { alignItems: ["center", 0, 0, 4], lineHeight: ["24", 0, 0, 4], paddingLeft: ["8", 0, 0, 4] } },
			".uni-searchbar__text-placeholder": { "": { fontSize: ["14", 0, 0, 5], color: ["#808080", 0, 0, 5], marginLeft: ["5", 0, 0, 5] } },
			".uni-searchbar__cancel": { "": { paddingLeft: ["10", 0, 0, 6], lineHeight: ["36", 0, 0, 6], fontSize: ["14", 0, 0, 6], color: ["#333333", 0, 0, 6] } },
			"@VERSION": 2,
		};
	},
	275: function (A, B, E) {
	...
	276: function (A, B, E) {
		...
		(function (A) {
			...
			var E = {
				data: function () {
					return { searchValue: "123123" };
				},
				methods: {
					search: function (A) {
						uni.showToast({ title: "\u641c\u7d22\uff1a" + A.value, icon: "none" });
					},
					input: function (B) {
						A("log", "----input:", B, " at pages/extUI/search-bar/search-bar.nvue:50");
					},
					clear: function (A) {
						uni.showToast({ title: "clear\u4e8b\u4ef6\uff0c\u6e05\u9664\u503c\u4e3a\uff1a" + A.value, icon: "none" });
					},
					blur: function (A) {
						uni.showToast({ title: "blur\u4e8b\u4ef6\uff0c\u8f93\u5165\u503c\u4e3a\uff1a" + A.value, icon: "none" });
					},
					focus: function (A) {
						uni.showToast({ title: "focus\u4e8b\u4ef6\uff0c\u8f93\u51fa\u503c\u4e3a\uff1a" + A.value, icon: "none" });
					},
					cancel: function (A) {
						uni.showToast({ title: "\u70b9\u51fb\u53d6\u6d88\uff0c\u8f93\u5165\u503c\u4e3a\uff1a" + A.value, icon: "none" });
					},
				},
	...
	277: function (A, B) {
		A.exports = {
			...
			".search-result": { "": { marginTop: ["10", 0, 0, 9], marginBottom: ["20", 0, 0, 9], textAlign: ["center", 0, 0, 9] } },
			".search-result-text": { "": { textAlign: ["center", 0, 0, 10], fontSize: ["14", 0, 0, 10] } },
			"@VERSION": 2,
		};
	},
	3: function (A, B, E) {
	...
	476: function (A, B, E) {
		...
		var e = { uniSection: E(13).default, uniSearchBar: E(696).default, uniIcons: E(16).default },
			c = function () {
				var A = this,
					B = A.$createElement,
					E = A._self._c || B;
				return E("scroll-view", { staticStyle: { flexDirection: "column" }, attrs: { scrollY: !0, showScrollbar: !0, enableBackToTop: !0, bubble: "true" } }, [
					E(
						"view",
						[
							E("uni-section", { attrs: { title: "\u57fa\u672c\u7528\u6cd5", type: "line" } }),
							E(
								"view",
								...
								[
									E("uni-search-bar", {
										attrs: { focus: !0 },
										on: { confirm: A.search, blur: A.blur, focus: A.focus, input: A.input, cancel: A.cancel, change: A.change, clear: A.clear },
										model: {
											value: A.searchValue,
											callback: function (B) {
												A.searchValue = B;
									...
									E("view", { staticClass: ["search-result"] }, [
										E("u-text", { staticClass: ["search-result-text"], appendAsTree: !0, attrs: { append: "tree" } }, [
											A._v("\u5f53\u524d\u8f93\u5165\u4e3a\uff1a" + A._s(A.searchValue)),
										]),
									]),
								],
								1,
							...
							E(
								...
								[
									E("uni-search-bar", {
										attrs: { placeholder: "\u81ea\u5b9a\u4e49placeholder", cancelText: "cancel" },
										on: { confirm: A.search, cancel: A.cancel },
									}),
									E("uni-search-bar", { attrs: { placeholder: "\u81ea\u5b9a\u4e49\u80cc\u666f\u8272", bgColor: "#EEEEEE" }, on: { confirm: A.search } }),
									E("uni-search-bar", { attrs: { radius: "100", placeholder: "\u81ea\u5b9a\u4e49\u5706\u89d2" }, on: { confirm: A.search } }),
								],
								1,
							),
							E("uni-section", { attrs: { title: "\u81ea\u5b9a\u4e49icon", type: "line" } }),
							E(
								"view",
								{ staticClass: ["example-body"] },
								[
									E(
										"uni-search-bar",
										{ attrs: { placeholder: "\u81ea\u5b9a\u4e49searchIcon", cancelText: "cancel" }, on: { confirm: A.search, cancel: A.cancel } },
										[E("uni-icons", { attrs: { slot: "searchIcon", color: "#999999", size: "18", type: "home" }, slot: "searchIcon" })],
										1,
									),
									E(
										"uni-search-bar",
										{ attrs: { placeholder: "\u81ea\u5b9a\u4e49clearIcon", cancelText: "cancel" }, on: { confirm: A.search, cancel: A.cancel } },
										[E("view", { staticStyle: { color: "#999999" }, attrs: { slot: "clearIcon" }, slot: "clearIcon" }, [E("u-text", [A._v("X")])])],
									),
								],
								1,
							),
							E("uni-section", { attrs: { title: "\u63a7\u5236\u6e05\u9664/\u53d6\u6d88\u6309\u94ae", type: "line" } }),
							E(
								"view",
								{ staticClass: ["example-body"] },
								[
									E("uni-search-bar", {
										attrs: { radius: "5", placeholder: "\u4e00\u76f4\u663e\u793a", clearButton: "always", cancelButton: "always" },
										on: { confirm: A.search, cancel: A.cancel },
									}),
									E("uni-search-bar", {
										attrs: { radius: "5", placeholder: "\u81ea\u52a8\u663e\u793a\u9690\u85cf", clearButton: "auto", cancelButton: "none" },
										on: { confirm: A.search },
									}),
									E("uni-search-bar", {
										attrs: { radius: "100", placeholder: "\u4e00\u76f4\u4e0d\u663e\u793a", clearButton: "none", cancelButton: "none" },
										on: { confirm: A.search },
									}),
								],
								1,
		...
		var e = { uniIcons: E(16).default },
			c = function () {
				var A = this,
					B = A.$createElement,
					E = A._self._c || B;
				return E("view", { staticClass: ["uni-searchbar"] }, [
					E(
						"view",
						{ staticClass: ["uni-searchbar__box"], style: { borderRadius: A.radius + "px", backgroundColor: A.bgColor }, on: { click: A.searchClick } },
						[
							E(
								"view",
								{ staticClass: ["uni-searchbar__box-icon-search"] },
								[A._t("searchIcon", [E("uni-icons", { attrs: { color: "#999999", size: "18", type: "search" } })])],
								2,
							),
							A.show || A.searchVal
								? E("u-input", {
										staticClass: ["uni-searchbar__box-search-input"],
										attrs: { focus: A.showSync, placeholder: A.placeholder, maxlength: A.maxlength, confirmType: "search", type: "text", value: A.searchVal },
										on: {
											confirm: A.confirm,
											blur: A.blur,
											focus: A.emitFocus,
											input: function (B) {
												A.searchVal = B.detail.value;
											},
										},
								  })
								: E("u-text", { staticClass: ["uni-searchbar__text-placeholder"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.placeholder))]),
							A.show && ("always" === A.clearButton || ("auto" === A.clearButton && "" !== A.searchVal))
								? E(
										"view",
										{ staticClass: ["uni-searchbar__box-icon-clear"], on: { click: A.clear } },
										[A._t("clearIcon", [E("uni-icons", { attrs: { color: "#c0c4cc", size: "15", type: "clear" } })])],
										2,
								  )
								: A._e(),
						],
					...
					"always" === A.cancelButton || (A.show && "auto" === A.cancelButton)
						? E("u-text", { staticClass: ["uni-searchbar__cancel"], appendAsTree: !0, attrs: { append: "tree" }, on: { click: A.cancel } }, [
								A._v(A._s(A.cancelText)),
						  ])
						: A._e(),
				]);
			},
	...
	695: function (A, B, E) {
		...
		"undefined" == typeof Promise ||
			...
			(e.default.route = "pages/extUI/search-bar/search-bar"),
			(e.default.el = "#root"),
			new Vue(e.default);
	},
	696: function (A, B, E) {
		...
		var g = E(0);
		var t = Object(g.a)(c.default, e.b, e.c, !1, null, "5dee2801", "5f2d25cf", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(E(589).default, this.options.style) : Object.assign(this.options.style, E(589).default);
		}).call(t),
			(B.default = t.exports);
	},
	7: function (A, B, E) {
	...
	96: function (A, B, E) {
		...
		var e = E(476),
			c = E(275),
			Q = E(0);
		var g = Object(Q.a)(c.default, e.b, e.c, !1, null, null, "174c04da", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(E(590).default, this.options.style) : Object.assign(this.options.style, E(590).default);
		}).call(g),
			(B.default = g.exports);
	},
});
