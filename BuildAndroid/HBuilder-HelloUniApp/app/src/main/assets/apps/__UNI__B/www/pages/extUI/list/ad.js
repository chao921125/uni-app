!(function (A) {
	...
	function t(e) {
		...
		var i = (B[e] = { i: e, l: !1, exports: {} });
		return A[e].call(i.exports, i, i.exports, t), (i.l = !0), i.exports;
	}
	(t.m = A),
		(t.c = B),
		(t.d = function (A, B, e) {
			t.o(A, B) || Object.defineProperty(A, B, { enumerable: !0, get: e });
		}),
		(t.r = function (A) {
		...
		(t.t = function (A, B) {
			if ((1 & B && (A = t(A)), 8 & B)) return A;
			if (4 & B && "object" == typeof A && A && A.__esModule) return A;
			var e = Object.create(null);
			if ((t.r(e), Object.defineProperty(e, "default", { enumerable: !0, value: A }), 2 & B && "string" != typeof A))
				for (var i in A)
					t.d(
						e,
						i,
	...
	0: function (A, B, t) {
		"use strict";
		function e(A, B, t, e, i, E, n, o, g, c) {
			var Q,
				s = "function" == typeof A ? A.options : A;
			if (g) {
				s.components || (s.components = {});
				var l = Object.prototype.hasOwnProperty;
				for (var r in g) l.call(g, r) && !l.call(s.components, r) && (s.components[r] = g[r]);
			}
			if (
				(c &&
					...
					(s.mixins || (s.mixins = [])).push(c)),
				B && ((s.render = B), (s.staticRenderFns = t), (s._compiled = !0)),
				e && (s.functional = !0),
	...
	10: function (A, B, t) {
		...
		var e,
			i = (e = t(17)) && e.__esModule ? e : { default: e };
		weex
			.requireModule("dom")
			.addRule("fontFace", {
				fontFamily: "uniicons",
	...
	13: function (A, B, t) {
		...
		var n = t(0);
		var o = Object(n.a)(i.default, e.b, e.c, !1, null, "168bca6c", "39eb9647", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				...
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(t(8).default, this.options.style) : Object.assign(this.options.style, t(8).default);
		}).call(o),
			(B.default = o.exports);
	},
	14: function (A, B, t) {
		...
		Object.defineProperty(B, "__esModule", { value: !0 }),
			...
			(B.default = function () {
				for (var A = arguments.length, B = new Array(A), t = 0; t < A; t++) B[t] = arguments[t];
				var n = B.shift();
				if (i()) return B.push(B.pop().replace("at ", "uni-app:///")), console[n].apply(console, B);
				...
				if (o.length > 1) {
					var c = o.pop();
					(g = o.join("---COMMA---")), 0 === c.indexOf(" at ") ? (g += c) : (g += "---COMMA---" + c);
				} else g = o[0];
				console[n](g);
			});
	},
	...
	16: function (A, B, t) {
		...
		var n = t(0);
		var o = Object(n.a)(i.default, e.b, e.c, !1, null, "041e7dc0", "67d6d51e", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	211: function (A, B, t) {
		...
		(function (A) {
			...
			var t = {
				components: {},
				data: function () {
					return { UNITS: { "\u5e74": 315576e5, "\u6708": 26298e5, "\u5929": 864e5, "\u5c0f\u65f6": 36e5, "\u5206\u949f": 6e4, "\u79d2": 1e3 }, listData: [] };
				},
				onLoad: function () {
					this.getList();
				},
				methods: {
					getList: function () {
						...
						uni.request({
							...
							success: function (t) {
								if (200 == t.statusCode) {
									var e = B.setTime(t.data);
									(B.listData = B.reload ? e : B.listData.concat(e)), A("log", B.listData, " at pages/extUI/list/ad.nvue:47");
								}
							},
							fail: function (B, t) {
								A("log", "fail" + JSON.stringify(B), " at pages/extUI/list/ad.nvue:51");
							},
						});
					},
					setTime: function (A) {
						...
						return (
							A.forEach(function (A) {
								t.push({ author_name: A.author_name, cover: A.cover, id: A.id, post_id: A.post_id, published_at: B.format(A.published_at), title: A.title });
							}),
							t
						);
					},
					format: function (A) {
						var B = this.parse(A),
							t = Date.now() - B.getTime();
						if (t < this.UNITS["\u5929"]) return this.humanize(t);
						var e = function (A) {
							return A < 10 ? "0" + A : A;
						};
						return B.getFullYear() + "/" + e(B.getMonth() + 1) + "/" + e(B.getDate()) + "-" + e(B.getHours()) + ":" + e(B.getMinutes());
					},
					parse: function (A) {
						var B = A.split(/[^0-9]/);
	...
	27: function (A, B, t) {
		...
		(function (A) {
			...
			var t = {
				...
				methods: {
					getForm: function () {
						for (var A = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "uniList", B = this.$parent, t = B.$options.name; t !== A; ) {
					...
					pageApi: function (B) {
						...
						uni[B]({
							...
							fail: function (B) {
								t.$emit("click", { data: B }), A("error", B.errMsg, " at components/uni-list-item/uni-list-item.vue:228");
							},
						});
					},
				},
	...
	31: function (A, B, t) {
		...
		var e = { uniIcons: t(16).default, uniBadge: t(43).default },
			i = function () {
				var A = this,
					B = A.$createElement,
					t = A._self._c || B;
				return t("cell", { appendAsTree: !0, attrs: { append: "tree" } }, [
					t(
						"view",
						{
						...
						[
							A.isFirstChild ? A._e() : t("view", { staticClass: ["border--left"], class: { "uni-list--border": A.border } }),
							t(
								"view",
								{
								...
								[
									A._t("header", [
										t("view", { staticClass: ["uni-list-item__header"] }, [
											A.thumb
												? t(
														"view",
														{ staticClass: ["uni-list-item__icon"] },
														[t("u-image", { staticClass: ["uni-list-item__icon-img"], class: ["uni-list--" + A.thumbSize], attrs: { src: A.thumb } })],
														1,
												  )
												: A.showExtraIcon
												? t(
														"view",
														{ staticClass: ["uni-list-item__icon"] },
														[t("uni-icons", { attrs: { color: A.extraIcon.color, size: A.extraIcon.size, type: A.extraIcon.type } })],
														1,
												  )
												: A._e(),
										]),
										...
										t(
											...
											[
												A.title
													...
													: A._e(),
												A.note
													? t("u-text", { staticClass: ["uni-list-item__content-note"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.note))])
													: A._e(),
											],
										),
									]),
									A._t("footer", [
										A.rightText || A.showBadge || A.showSwitch
											? t(
													...
													[
														A.rightText
															? t("u-text", { staticClass: ["uni-list-item__extra-text"], appendAsTree: !0, attrs: { append: "tree" } }, [
																	A._v(A._s(A.rightText)),
															  ])
															: A._e(),
														A.showBadge ? t("uni-badge", { attrs: { type: A.badgeType, text: A.badgeText } }) : A._e(),
														A.showSwitch
															? t("switch", { attrs: { disabled: A.disabled, checked: A.switchChecked }, on: { change: A.onSwitchChange } })
															: A._e(),
													],
													1,
											  )
							...
							A.showArrow || A.link ? t("uni-icons", { staticClass: ["uni-icon-wrapper"], attrs: { size: 16, color: "#bbb", type: "arrowright" } }) : A._e(),
						],
						1,
					),
				]);
	...
	43: function (A, B, t) {
		...
		var n = t(0);
		var o = Object(n.a)(i.default, e.b, e.c, !1, null, "6ee486c2", "327cd37a", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(t(33).default, this.options.style) : Object.assign(this.options.style, t(33).default);
		}).call(o),
			(B.default = o.exports);
	},
	439: function (A, B, t) {
		...
		var e = { uniSection: t(13).default, uniList: t(46).default, uniListItem: t(55).default },
			i = function () {
				var A = this.$createElement,
					B = this._self._c || A;
					...
					B(
						...
						[
							B("u-text", { staticClass: ["example-info"], appendAsTree: !0, attrs: { append: "tree" } }, [
								this._v("\u6b64\u793a\u4f8b\u5c55\u793a\u4e86ad\u5e7f\u544a\u7ec4\u4ef6\u5728 uni-list \u4e2d\u7684\u5e94\u7528"),
							]),
							B("uni-section", { attrs: { title: "\u5217\u8868\u5d4c\u5957\u5e7f\u544a", type: "line" } }),
							B(
								"uni-list",
								[
									this._l(this.listData, function (A, t) {
										return [
											t > 0 && (t + 1) % 10 == 0
												? B("ad", { attrs: { adpid: "1111111111", unitId: "", appid: "", apid: "", type: "feed" } })
												: B("uni-list-item", { attrs: { title: A.title, note: A.author_name, thumb: A.cover, thumbSize: "lg" } }),
										];
									}),
								],
								2,
	...
	46: function (A, B, t) {
		...
		var n = t(0);
		var o = Object(n.a)(i.default, e.b, e.c, !1, null, "34ed0c8e", "c74315e2", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(t(34).default, this.options.style) : Object.assign(this.options.style, t(34).default);
		}).call(o),
			(B.default = o.exports);
	},
	5: function (A, B, t) {
		...
		var e = function () {
				...
				return t(
					...
					[
						A.type ? t("view", { staticClass: ["uni-section__head"] }, [t("view", { staticClass: ["uni-section__head-tag"], class: A.type })]) : A._e(),
						t("view", { staticClass: ["uni-section__content"] }, [
							t("u-text", { staticClass: ["uni-section__content-title"], class: { distraction: !A.subTitle }, appendAsTree: !0, attrs: { append: "tree" } }, [
								A._v(A._s(A.title)),
							]),
							A.subTitle
								? t("u-text", { staticClass: ["uni-section__content-sub"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.subTitle))])
								: A._e(),
						]),
						A._t("default"),
					],
	...
	55: function (A, B, t) {
		...
		var n = t(0);
		var o = Object(n.a)(i.default, e.b, e.c, !1, null, null, "7f6e3081", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(t(44).default, this.options.style) : Object.assign(this.options.style, t(44).default);
		}).call(o),
			(B.default = o.exports);
	},
	569: function (A, B, t) {
	...
	671: function (A, B, t) {
		...
		"undefined" == typeof Promise ||
			...
			(e.default.route = "pages/extUI/list/ad"),
			(e.default.el = "#root"),
			new Vue(e.default);
	},
	7: function (A, B, t) {
	...
	86: function (A, B, t) {
		...
		var e = t(439),
			i = t(210),
			E = t(0);
		var n = Object(E.a)(i.default, e.b, e.c, !1, null, null, "35dec816", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(t(569).default, this.options.style) : Object.assign(this.options.style, t(569).default);
		}).call(n),
			(B.default = n.exports);
	},
	9: function (A, B, t) {
