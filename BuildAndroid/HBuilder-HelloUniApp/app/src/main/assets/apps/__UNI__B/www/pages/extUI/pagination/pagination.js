!(function (A) {
	...
	0: function (A, B, E) {
		"use strict";
		function t(A, B, E, t, e, g, i, Q, n, c) {
			var o,
	...
	103: function (A, B, E) {
		...
		var t = E(469),
			e = E(322),
			g = E(0);
		var i = Object(g.a)(e.default, t.b, t.c, !1, null, null, "8ddd6f4c", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				...
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(E(605).default, this.options.style) : Object.assign(this.options.style, E(605).default);
		}).call(i),
			(B.default = i.exports);
	},
	11: function (A, B) {
	...
	13: function (A, B, E) {
		...
		var i = E(0);
		var Q = Object(i.a)(e.default, t.b, t.c, !1, null, "168bca6c", "39eb9647", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	14: function (A, B, E) {
		...
		Object.defineProperty(B, "__esModule", { value: !0 }),
			...
			(B.default = function () {
				...
				var i = B.shift();
				if (e()) return B.push(B.pop().replace("at ", "uni-app:///")), console[i].apply(console, B);
				var Q = B.map(function (A) {
						var B = Object.prototype.toString.call(A).toLowerCase();
						if ("[object object]" === B || "[object array]" === B)
							try {
								A = "---BEGIN:JSON---" + JSON.stringify(A, g) + "---END:JSON---";
							} catch (E) {
								A = B;
							}
				...
				if (Q.length > 1) {
					var c = Q.pop();
					(n = Q.join("---COMMA---")), 0 === c.indexOf(" at ") ? (n += c) : (n += "---COMMA---" + c);
				} else n = Q[0];
				console[i](n);
			});
	},
	...
	16: function (A, B, E) {
		...
		var i = E(0);
		var Q = Object(i.a)(e.default, t.b, t.c, !1, null, "041e7dc0", "67d6d51e", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	320: function (A, B, E) {
		...
		var t = {
			...
			data: function () {
				return { currentIndex: 1, paperData: [] };
			},
			computed: {
				maxPage: function () {
					var A = 1,
					...
					return B && E && (A = Math.ceil(B / E)), A;
				},
				paper: function () {
					for (var A = this.currentIndex, B = this.pagerCount, E = this.total, t = this.pageSize, e = [], g = [], i = Math.ceil(E / t), Q = 0; Q < i; Q++)
						e.push(Q + 1);
					g.push(1);
					var n = e[e.length - (B + 1) / 2];
					return (
						e.forEach(function (E, t) {
							(B + 1) / 2 >= A
								? E < B + 1 && E > 1 && g.push(E)
								: A + 2 <= n
								? E > A - (B + 1) / 2 && E < A + (B + 1) / 2 && g.push(E)
								: (E > A - (B + 1) / 2 || i - B < E) && E < e[e.length - 1] && g.push(E);
						}),
						i > B
							? ((B + 1) / 2 >= A ? (g[g.length - 1] = "...") : A + 2 <= n ? ((g[1] = "..."), (g[g.length - 1] = "...")) : (g[1] = "..."),
							  g.push(e[e.length - 1]))
							: (B + 1) / 2 >= A || A + 2 <= n || (g.shift(), g.push(e[e.length - 1])),
						g
					);
				},
			},
			...
			methods: {
				selectPage: function (A, B) {
					if (parseInt(A)) (this.currentIndex = A), this.change("current");
					else {
						var E = Math.ceil(this.total / this.pageSize);
						if (B <= 1) return void (this.currentIndex - 5 > 1 ? (this.currentIndex -= 5) : (this.currentIndex = 1));
						if (B >= 6) return void (this.currentIndex + 5 > E ? (this.currentIndex = E) : (this.currentIndex += 5));
					}
				},
				clickLeft: function () {
				...
				change: function (A) {
					this.$emit("input", this.currentIndex), this.$emit("change", { type: A, current: this.currentIndex });
				},
			},
		};
		B.default = t;
	...
	321: function (A, B) {
		A.exports = {
			...
			".uni-pagination__total": { "": { fontSize: ["14", 0, 0, 1], color: ["#999999", 0, 0, 1], marginRight: ["15", 0, 0, 1] } },
			".uni-pagination__btn": {
				"": {
					paddingTop: [0, 0, 0, 2],
			...
			".uni-pagination__num-tag": {
				"": {
					...
					marginLeft: ["5", 0, 0, 5],
					height: ["30", 0, 0, 5],
					textAlign: ["center", 0, 0, 5],
					lineHeight: ["30", 0, 0, 5],
					color: ["#666666", 0, 0, 5],
				},
			},
			".uni-pagination__num-current": { "": { flexDirection: ["row", 0, 0, 6] } },
			".uni-pagination__num-current-text": { "": { fontSize: ["15", 0, 0, 7] } },
			".uni-pagination--enabled": { "": { color: ["#333333", 0, 0, 8], opacity: [1, 0, 0, 8] } },
			".uni-pagination--disabled": { "": { opacity: [0.5, 0, 0, 9] } },
			".uni-pagination--hover": { "": { color: ["rgba(0,0,0,0.6)", 0, 0, 10], backgroundColor: ["#f1f1f1", 0, 0, 10] } },
			".tag--active": { "": { "color:hover": ["#007aff", 0, 0, 11] } },
			".page--active": { "": { color: ["#ffffff", 0, 0, 12], backgroundColor: ["#007aff", 0, 0, 12], "color:hover": ["#ffffff", 0, 0, 13] } },
			"@VERSION": 2,
		};
	},
	322: function (A, B, E) {
		...
		(function (A) {
			...
			var E = {
				...
				methods: {
					...
					reset: function () {
						(this.total = 0), (this.current = 1);
					},
					change: function (B) {
						A("log", B, " at pages/extUI/pagination/pagination.nvue:48"), (this.current = B.current);
					},
				},
			};
			B.default = E;
	...
	469: function (A, B, E) {
		...
		var t = { uniSection: E(13).default, uniPagination: E(713).default },
			e = function () {
				var A = this,
					B = A.$createElement,
					E = A._self._c || B;
				return E("scroll-view", { staticStyle: { flexDirection: "column" }, attrs: { scrollY: !0, showScrollbar: !0, enableBackToTop: !0, bubble: "true" } }, [
					E(
						"view",
						[
							E("uni-section", { attrs: { title: "\u9ed8\u8ba4\u6837\u5f0f", type: "line" } }),
							E("view", { staticClass: ["example-body"] }, [E("uni-pagination", { attrs: { total: 50, title: "\u6807\u9898\u6587\u5b57" } })], 1),
							E("uni-section", { attrs: { title: "\u4fee\u6539\u6309\u94ae\u6587\u5b57", type: "line" } }),
							E(
								"view",
								{ staticClass: ["example-body"] },
								[
									E("uni-pagination", {
										attrs: { total: 50, title: "\u6807\u9898\u6587\u5b57", prevText: "\u524d\u4e00\u9875", nextText: "\u540e\u4e00\u9875" },
									}),
								],
								1,
							),
							E("uni-section", { attrs: { title: "\u56fe\u6807\u6837\u5f0f", type: "line" } }),
							E("view", { staticClass: ["example-body"] }, [E("uni-pagination", { attrs: { showIcon: !0, total: 50, title: "\u6807\u9898\u6587\u5b57" } })], 1),
							E("uni-section", { attrs: { title: "\u4fee\u6539\u6570\u636e\u957f\u5ea6", type: "line" } }),
							E(
								"view",
								{ staticClass: ["example-body"] },
								[
									E("uni-pagination", {
										attrs: { current: A.current, total: A.total, title: "\u6807\u9898\u6587\u5b57", showIcon: !0 },
										on: { change: A.change },
									}),
								],
								1,
							...
							E(
								...
								[
									...
									E(
										...
										[E("u-text", { staticClass: ["word-btn-white"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v("\u589e\u52a010\u6761\u6570\u636e")])],
									),
									E("button", { staticClass: ["button"], attrs: { type: "default" }, on: { click: A.reset } }, [A._v("\u91cd\u7f6e\u6570\u636e")]),
								],
								1,
							),
						],
	...
	497: function (A, B, E) {
		...
		var t = { uniIcons: E(16).default },
			e = function () {
				var A = this,
					B = A.$createElement,
					E = A._self._c || B;
				return E("view", { staticClass: ["uni-pagination"] }, [
					E("view", { staticClass: ["uni-pagination__total", "is-phone-hide"] }, [E("u-text", [A._v("\u5171 " + A._s(A.total) + " \u6761")])]),
					E(
						"view",
						{
							staticClass: ["uni-pagination__btn"],
							class: 1 === A.currentIndex ? "uni-pagination--disabled" : "uni-pagination--enabled",
							attrs: { hoverClass: 1 === A.currentIndex ? "" : "uni-pagination--hover", hoverStartTime: 20, hoverStayTime: 70 },
							on: { click: A.clickLeft },
						},
						[
							!0 === A.showIcon || "true" === A.showIcon
								? [E("uni-icons", { attrs: { color: "#666", size: "16", type: "arrowleft" } })]
								: [E("u-text", { staticClass: ["uni-pagination__child-btn"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.prevText))])],
						],
						2,
					),
					E("view", { staticClass: ["uni-pagination__num", "uni-pagination__num-flex-none"] }, [
						E(
							"view",
							...
							[
								E(
									"u-text",
									{
										staticClass: ["uni-pagination__num-current-text", "is-pc-hide"],
										staticStyle: { color: "#409EFF" },
										appendAsTree: !0,
										attrs: { append: "tree" },
									},
									[A._v(A._s(A.currentIndex))],
								),
								E("u-text", { staticClass: ["uni-pagination__num-current-text", "is-pc-hide"], appendAsTree: !0, attrs: { append: "tree" } }, [
									A._v("/" + A._s(A.maxPage || 0)),
								]),
								A._l(A.paper, function (B, t) {
									return E(
										"view",
										{
											key: t,
											staticClass: ["uni-pagination__num-tag", "tag--active", "is-phone-hide"],
											class: { "page--active": B === A.currentIndex },
											on: {
												click: function (E) {
													A.selectPage(B, t);
												},
										...
										[E("u-text", { appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(B))])],
									);
								}),
							],
							2,
					...
					E(
						...
						{
							staticClass: ["uni-pagination__btn"],
							class: A.currentIndex >= A.maxPage ? "uni-pagination--disabled" : "uni-pagination--enabled",
							attrs: { hoverClass: A.currentIndex === A.maxPage ? "" : "uni-pagination--hover", hoverStartTime: 20, hoverStayTime: 70 },
							on: { click: A.clickRight },
						},
						[
							!0 === A.showIcon || "true" === A.showIcon
								? [E("uni-icons", { attrs: { color: "#666", size: "16", type: "arrowright" } })]
								: [E("u-text", { staticClass: ["uni-pagination__child-btn"], appendAsTree: !0, attrs: { append: "tree" } }, [A._v(A._s(A.nextText))])],
						],
						2,
					),
				]);
	...
	712: function (A, B, E) {
		...
		"undefined" == typeof Promise ||
			...
			(t.default.route = "pages/extUI/pagination/pagination"),
			(t.default.el = "#root"),
			new Vue(t.default);
	},
	713: function (A, B, E) {
		...
		var i = E(0);
		var Q = Object(i.a)(e.default, t.b, t.c, !1, null, "5161c35b", "3c9d2f62", !1, t.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(E(604).default, this.options.style) : Object.assign(this.options.style, E(604).default);
		}).call(Q),
			(B.default = Q.exports);
	},
	8: function (A, B, E) {
