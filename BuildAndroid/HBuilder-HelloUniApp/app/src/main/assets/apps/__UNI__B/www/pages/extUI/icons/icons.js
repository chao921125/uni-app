!(function (A) {
	...
	function E(e) {
		...
		var Q = (B[e] = { i: e, l: !1, exports: {} });
		return A[e].call(Q.exports, Q, Q.exports, E), (Q.l = !0), Q.exports;
	}
	(E.m = A),
		(E.c = B),
		(E.d = function (A, B, e) {
	...
	0: function (A, B, E) {
		"use strict";
		function e(A, B, E, e, Q, c, g, i, n, o) {
			var w,
				t = "function" == typeof A ? A.options : A;
			if (n) {
				t.components || (t.components = {});
				var F = Object.prototype.hasOwnProperty;
				for (var I in n) F.call(n, I) && !F.call(t.components, I) && (t.components[I] = n[I]);
			}
			if (
				(o &&
					...
					(t.mixins || (t.mixins = [])).push(o)),
				B && ((t.render = B), (t.staticRenderFns = E), (t._compiled = !0)),
				e && (t.functional = !0),
				c && (t._scopeId = "data-v-" + c),
				g
					? ((w = function (A) {
				...
				if (t.functional) {
					...
					t.render = function (A, B) {
						return w.call(B), l(A, B);
					};
				} else {
					var C = t.beforeCreate;
					t.beforeCreate = C ? [].concat(C, w) : [w];
				}
			return { exports: A, options: t };
		}
		E.d(B, "a", function () {
			return e;
		});
	...
	10: function (A, B, E) {
		...
		var e,
			Q = (e = E(17)) && e.__esModule ? e : { default: e };
		weex
			.requireModule("dom")
			.addRule("fontFace", {
				fontFamily: "uniicons",
	...
	112: function (A, B, E) {
		...
		var e = E(431),
			Q = E(379),
			c = E(0);
		var g = Object(c.a)(Q.default, e.b, e.c, !1, null, null, "13ecd51e", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				...
				Vue.prototype.__merge_style ? Vue.prototype.__merge_style(E(624).default, this.options.style) : Object.assign(this.options.style, E(624).default);
		}).call(g),
			(B.default = g.exports);
	},
	12: function (A, B, E) {
	...
	13: function (A, B, E) {
		...
		var g = E(0);
		var i = Object(g.a)(Q.default, e.b, e.c, !1, null, "168bca6c", "39eb9647", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	16: function (A, B, E) {
		...
		var g = E(0);
		var i = Object(g.a)(Q.default, e.b, e.c, !1, null, "041e7dc0", "67d6d51e", !1, e.a, void 0);
		(function (A) {
			this.options.style || (this.options.style = {}),
				Vue.prototype.__merge_style && Vue.prototype.__$appStyle__ && Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style),
	...
	380: function (A, B, E) {
		...
		B.default = {
			...
			methods: {
				change: function (A) {
					this.checked = !("false" === A.detail.value || !A.detail.value);
				},
	...
	381: function (A, B) {
		A.exports = {
			...
			".uni-right": {
				"": { flexDirection: ["row", 0, 0, 10], flexWrap: ["nowrap", 0, 0, 10], alignItems: ["center", 0, 0, 10], color: ["#666666", 0, 0, 10] },
			},
			".uni-right-text": { "": { fontSize: ["28rpx", 0, 0, 11] } },
			".switch": { "": { transform: ["scale(0.8)", 0, 0, 12], marginLeft: ["5", 0, 0, 12] } },
			".icon-item": {
				"": {
					width: ["180rpx", 0, 0, 13],
					paddingTop: ["30rpx", 0, 0, 13],
					paddingRight: ["10rpx", 0, 0, 13],
					paddingBottom: ["30rpx", 0, 0, 13],
					paddingLeft: ["10rpx", 0, 0, 13],
					textAlign: ["center", 0, 0, 13],
					flexDirection: ["column", 0, 0, 13],
				},
			},
			".icon-item-text": { "": { fontSize: ["24rpx", 0, 0, 14], textAlign: ["center", 0, 0, 14] } },
			"@VERSION": 2,
		};
	},
	4: function (A, B) {
	...
	431: function (A, B, E) {
		...
		var e = { uniSection: E(13).default, uniIcons: E(16).default },
			Q = function () {
				var A = this,
					B = A.$createElement,
					E = A._self._c || B;
				return E("scroll-view", { staticStyle: { flexDirection: "column" }, attrs: { scrollY: !0, showScrollbar: !0, enableBackToTop: !0, bubble: "true" } }, [
					E(
						...
						[
							...
							E("uni-section", { attrs: { title: "\u57fa\u7840\u56fe\u6807", type: "line" } }, [
								E(
									"view",
									{ staticClass: ["uni-right"] },
									[
										E("u-text", { staticClass: ["uni-right-text"], appendAsTree: !0, attrs: { append: "tree" } }, [
											A._v("\u663e\u793a" + A._s(A.checked ? " unicode" : "\u56fe\u6807\u540d")),
										]),
										E("switch", { staticClass: ["switch"], attrs: { checked: A.checked }, on: { change: A.change } }),
									],
									1,
								),
							]),
							E(
								...
								A._l(A.iconClassList, function (B, e) {
									return E(
										"view",
										{
											key: e,
										...
										[
											E("uni-icons", { attrs: { type: B.name, color: A.activeIndex === e ? "#007aff" : "#8f8f94", size: "25" } }),
											E(
												"u-text",
												{
													staticClass: ["icon-item-text"],
													style: { color: A.activeIndex === e ? "#007aff" : "#8f8f94" },
													appendAsTree: !0,
													attrs: { append: "tree" },
												},
												[A._v(A._s(A.checked ? B.unicode : B.name))],
											),
										],
										1,
									);
	...
	734: function (A, B, E) {
		...
		"undefined" == typeof Promise ||
			...
			(e.default.route = "pages/extUI/icons/icons"),
			(e.default.el = "#root"),
			new Vue(e.default);
	},
	8: function (A, B, E) {
