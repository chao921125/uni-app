	...
	return (function (t) {
		...
		function (t, e, n) {
			...
			var r = n(76),
				...
				c = n(79),
				a = n(80);
			(o.prototype.clear = r), (o.prototype.delete = i), (o.prototype.get = u), (o.prototype.has = c), (o.prototype.set = a), (t.exports = o);
		},
		function (t, e, n) {
			function o(t, e) {
			...
			var u = n(9),
				c = (function (t) {
					function e() {
						...
						return (
							(n = i = r(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(a)))),
							(i.onCreate = function () {
								(i.display = document.createElement("div")), i.display.classList.add("ql-image-size"), i.overlay.appendChild(i.display);
							}),
							(i.onDestroy = function () {}),
							(i.onUpdate = function () {
								if (i.display && i.img) {
									var t = i.getCurrentSize();
									(i.display.innerHTML = t.join(" &times; ")), Object.assign(i.display.style, { right: "4px", top: "4px", left: "auto" });
								}
							}),
		...
		function (t, e, n) {
			...
			var f = (function (t) {
				function e() {
					...
					return (
						(n = i = r(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(f)))),
						(i.onCreate = function () {
		...
		function (t, e, n) {
			...
			var r = n(3),
				...
				a = n(96),
				s = n(97);
			(o.prototype.clear = i), (o.prototype.delete = u), (o.prototype.get = c), (o.prototype.has = a), (o.prototype.set = s), (t.exports = o);
		},
		function (t, e, n) {
			var o = n(1),
				r = o.Uint8Array;
		...
		function (t, e, n) {
			function o(t, e) {
				...
				for (var y in t)
					(!e && !p.call(t, y)) ||
						(d && ("length" == y || (f && ("offset" == y || "parent" == y)) || (l && ("buffer" == y || "byteLength" == y || "byteOffset" == y)) || a(y, v))) ||
						h.push(y);
				return h;
			}
			var r = n(54),
			...
			function o(t) {
				return r(function (e, n) {
					var o = -1,
						...
						c = r > 2 ? n[2] : void 0;
					for (
						u = t.length > 3 && "function" == typeof u ? (r--, u) : void 0, c && i(n[0], n[1], c) && ((u = r < 3 ? void 0 : u), (r = 1)), e = Object(e);
						++o < r;
		...
		function (t, e, n) {
			function o(t, e, n) {
				return (
					...
					function () {
						for (var o = arguments, u = -1, c = i(o.length - e, 0), a = Array(c); ++u < c; ) a[u] = o[e + u];
						u = -1;
