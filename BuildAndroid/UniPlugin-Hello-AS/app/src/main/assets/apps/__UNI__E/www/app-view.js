(function (t) {
				...
				return n(
					...
					[
						n(
							...
							[n("v-uni-text", { staticClass: t._$g(2, "sc"), attrs: { _i: 2 } }, [t._v("uni原生插件示例")])],
							1,
						),
						t._l(t._$g(3, "f"), function (e, r, i, o) {
							return n(
								"v-uni-view",
								{ key: e, staticClass: t._$g("3-" + o, "sc"), attrs: { _i: "3-" + o } },
								[
									n(
										"v-uni-view",
										{
											staticClass: t._$g("4-" + o, "sc"),
											class: t._$g("4-" + o, "c"),
											attrs: { _i: "4-" + o },
											on: {
												click: function (e) {
										...
										[
											n("v-uni-text", { staticClass: t._$g("5-" + o, "sc"), attrs: { _i: "5-" + o } }, [t._v(t._$g("5-" + o, "t0-0"))]),
											n("v-uni-text", { staticClass: t._$g("6-" + o, "sc"), class: t._$g("6-" + o, "c"), attrs: { _i: "6-" + o } }, [
												t._v(t._$g("6-" + o, "t0-0")),
											]),
										],
										1,
									...
									t._$g("7-" + o, "i")
										? n(
												"v-uni-view",
												{ staticClass: t._$g("7-" + o, "sc"), attrs: { _i: "7-" + o } },
												t._l(t._$g("8-" + o, "f"), function (e, r, i, a) {
													return n(
														"v-uni-view",
														{
															key: e,
															staticClass: t._$g("8-" + o + "-" + a, "sc"),
															attrs: { _i: "8-" + o + "-" + a },
															on: {
																click: function (e) {
																	return t.$handleViewEvent(e);
														...
														[
															n("v-uni-text", { staticClass: t._$g("9-" + o + "-" + a, "sc"), attrs: { _i: "9-" + o + "-" + a } }, [
																t._v(t._$g("9-" + o + "-" + a, "t0-0")),
															]),
															n("v-uni-text", { staticClass: t._$g("10-" + o + "-" + a, "sc"), attrs: { _i: "10-" + o + "-" + a } }, [t._v("")]),
														],
														1,
													);
												}),
	...
	"59bd": function (t, e, n) {
		...
		var a,
			c = n("f0c5"),
			u = Object(c["a"])(i["default"], r["b"], r["c"], !1, null, null, null, !1, r["a"], a);
		e["default"] = u.exports;
	},
	6937: function (t, e, n) {
		var r = n("aafe");
		"string" === typeof r && (r = [[t.i, r, ""]]), r.locals && (t.exports = r.locals);
		var i = n("7f7e").default;
		i("bf9c0ac4", r, !0, { sourceMap: !1, shadowMode: !1 });
	},
	"6c42": function (t, e, n) {
		"use strict";
		n.r(e);
	...
	"7f7e": function (t, e, n) {
		...
		function r(t, e) {
			for (var n = [], r = {}, i = 0; i < e.length; i++) {
				var o = e[i],
					...
					u = o[2],
					s = o[3],
					f = { id: t + ":" + i, css: c, media: u, sourceMap: s };
		...
		function v(t) {
			...
			if (p) {
				var i = u++;
				(r = c || (c = x())), (e = m.bind(null, r, i, !1)), (n = m.bind(null, r, i, !0));
			} else
				(r = x()),
					(e = w.bind(null, r)),
					(n = function () {
		...
		var _ = /([+-]?\d+(\.\d+)?)[r|u]px/g,
			k = /var\(--status-bar-height\)/gi,
			y = /var\(--window-top\)/gi,
			C = /var\(--window-bottom\)/gi,
			$ = !1;
		function j(t) {
			if (!uni.canIUse("css.var")) {
				!1 === $ && ($ = plus.navigator.getStatusbarHeight());
				var e = { statusBarHeight: $, top: window.__WINDOW_TOP || 0, bottom: window.__WINDOW_BOTTOM || 0 };
				t = t
					.replace(k, e.statusBarHeight + "px")
					.replace(y, e.top + "px")
					.replace(C, e.bottom + "px");
			}
	...
	"8b75": function (t, e, n) {
		...
		n("4a0d"), "undefined" !== typeof plus ? r() : document.addEventListener("plusready", r);
	},
	"8c75": function (t, e, n) {
		"use strict";
		var r,
	...
	aafe: function (t, e, n) {
		...
		(e = r(!1)),
			e.push([
				t.i,
				"uni-button{margin-top:30upx;margin-bottom:30upx}.button-sp-area{margin:0 auto;width:60%}.content{text-align:center;height:400upx}.wrapper{-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center}.button{width:200px;margin-top:30px;margin-left:20px;padding-top:20px;padding-bottom:20px;border-width:2px;border-style:solid;border-color:#458b00;background-color:#458b00}.text{font-size:30px;color:#666;text-align:center}",
				"",
			]),
			(t.exports = e);
	},
	...
	f0c5: function (t, e, n) {
		"use strict";
		function r(t, e, n, r, i, o, a, c, u, s) {
			var f,
	...
	f483: function (t, e, n) {
		...
		"string" === typeof r && (r = [[t.i, r, ""]]), r.locals && (t.exports = r.locals);
		var i = n("7f7e").default;
		i("3ee0e078", r, !0, { sourceMap: !1, shadowMode: !1 });
	},
	f529: function (t, e, n) {
		"use strict";
		Object.defineProperty(e, "__esModule", { value: !0 }), (e.default = void 0);
