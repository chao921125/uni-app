!(function (t) {
	...
	function (t, e, n) {
		...
		var i = n(9),
			o = n(5),
			a = n(2),
			r = Object(a.a)(o.default, i.b, i.c, !1, null, null, "3dc4405c", !1, i.a, void 0);
		e.default = r.exports;
	},
	,
	function (t, e, n) {
	...
	function (t, e, n) {
		...
		(function (t) {
			...
			var n = {
				...
				methods: {
					onTel: function (e) {
						t("log", "onTel=" + e.detail.tel, " at pages\\sample\\ext-component.nvue:17");
					},
					...
					e(
						...
						[
							e("myText", {
								...
								attrs: { tel: "12305" },
								on: { onTel: this.onTel, click: this.myTextClick },
							}),
						],
						1,
					),
	...
	function (t, e, n) {
		...
		n(11), n(15);
		var i = n(3);
		(i.default.mpType = "page"), (i.default.route = "pages/sample/ext-component"), (i.default.el = "#root"), new Vue(i.default);
	},
	function (t, e, n) {
		"use strict";
		function i(t) {
		...
		Object.defineProperty(e, "__esModule", { value: !0 }),
			...
			(e.default = function () {
				...
				if (r.length > 1) {
					var u = r.pop();
					(s = r.join("---COMMA---")), 0 === u.indexOf(" at ") ? (s += u) : (s += "---COMMA---" + u);
				} else s = r[0];
				console[a](s);
			});
	},
