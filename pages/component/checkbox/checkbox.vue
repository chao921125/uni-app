<template>
	<view>
		...
		<view class="uni-padding-wrap uni-common-mt">
			...
			<view>
				<checkbox-group>
					<label> <checkbox value="cb1" checked="true" color="#FFCC33" style="transform: scale(0.7)" />选中 </label>
					<label> <checkbox value="cb" color="#FFCC33" style="transform: scale(0.7)" />未选中 </label>
				</checkbox-group>
			</view>
		</view>
