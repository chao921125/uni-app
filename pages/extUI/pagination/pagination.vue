	...
	<view>
		...
		<uni-section title="修改数据长度" type="line" padding>
			...
			<view class="btn-view">
				...
				<view class="btn-flex">
					<button class="button word-btn" hover-class="word-btn--hover" :hover-start-time="20" :hover-stay-time="70" @click="add"><text class="word-btn-white">增加10条数据</text></button>
