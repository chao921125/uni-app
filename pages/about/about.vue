			...
			<view class="source">
				...
				<view class="source-list">
					...
					<view class="source-cell">
						...
						<u-link class="link" :href="'https://github.com/dcloudio/uni-mini'" :text="'https://github.com/dcloudio/uni-mini'"></u-link>
					</view>
				</view>
			</view>
			<!-- #ifdef APP-PLUS -->
		...
		share(e) {
			...
			uni.showActionSheet({
				...
				success: (res) => {
					...
					uni.share({
						provider: provider,
						scene: this.providerList[res.tapIndex].type && this.providerList[res.tapIndex].type === "WXSceneTimeline" ? "WXSceneTimeline" : "WXSceneSession",
