				...
				function e() {
					...
					return (
						...
						(i.addBox = function (t) {
							...
							e.classList.add("ql-image-handle"), (e.style.cursor = t), e.addEventListener(c ? "touchstart" : "mousedown", i.handleMousedown, !1), i.overlay.appendChild(e), i.boxes.push(e);
						}),
						(i.handleMousedown = function (t) {
							i.dragBox = t.target;
							var e = c ? t.changedTouches[0] : t;
							(i.dragStartX = e.clientX), (i.preDragWidth = i.img.width || i.img.naturalWidth), i.setCursor(i.dragBox.style.cursor), document.addEventListener(c ? "touchmove" : "mousemove", i.handleDrag, a), document.addEventListener(c ? "touchend" : "mouseup", i.handleMouseup, !1);
						}),
						(i.handleMouseup = function () {
							i.setCursor(""), document.removeEventListener(c ? "touchmove" : "mousemove", i.handleDrag), document.removeEventListener(c ? "touchend" : "mouseup", i.handleMouseup);
						}),
						(i.handleDrag = function (t) {
							if (i.img) {
								var e = c ? t.changedTouches[0] : t,
									n = e.clientX - i.dragStartX;
								i.dragBox === i.boxes[0] || i.dragBox === i.boxes[3] ? (i.img.width = Math.round(i.preDragWidth - n)) : (i.img.width = Math.round(i.preDragWidth + n)), i.requestUpdate(), t.preventDefault();
							}
						}),
				...
				c = (function (t) {
					function e() {
						...
						return (
							(n = i = r(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(a)))),
							(i.onCreate = function () {
								(i.toolbar = document.createElement("div")), i.toolbar.classList.add("ql-image-toolbar"), i.overlay.appendChild(i.toolbar), i._addToolbarButtons();
							}),
							(i.onDestroy = function () {}),
							(i.onUpdate = function () {}),
				...
				p = function t(e) {
					...
					o(this, t),
						...
						(this.showOverlay = function () {
							n.overlay && n.hideOverlay(), n.quill.setSelection(null), n.setUserSelect("none"), document.addEventListener("keyup", n.checkImage, !0), n.quill.root.addEventListener("input", n.checkImage, !0), (n.overlay = document.createElement("div")), n.overlay.classList.add("ql-image-overlay"), n.quill.root.parentNode.appendChild(n.overlay), n.repositionElements();
						}),
						...
						(this.quill = e);
					var c = !1;
					r.modules && (c = r.modules.slice()), (this.options = i()({}, r, u.a)), !1 !== c && (this.options.modules = c), document.execCommand("enableObjectResizing", !1, "false"), this.quill.root.addEventListener("click", this.handleClick, !1), (this.quill.root.parentNode.style.position = this.quill.root.parentNode.style.position || "relative"), (this.moduleClasses = this.options.modules), (this.modules = []);
				};
		...
		function (t, e, n) {
			function o(t, e) {
				var n = u(t),
					...
					v = h.length;
				for (var y in t) (!e && !p.call(t, y)) || (d && ("length" == y || (f && ("offset" == y || "parent" == y)) || (l && ("buffer" == y || "byteLength" == y || "byteOffset" == y)) || a(y, v))) || h.push(y);
				return h;
			}
			var r = n(54),
				i = n(28),
			...
			function o(t, e, n, o, g, _, m) {
				...
				if (z) {
					var C = f(w),
						P = !C && l(w),
						S = !C && !P && y(w);
					(E = w), C || P || S ? (f(j) ? (E = j) : p(j) ? (E = c(j)) : P ? ((z = !1), (E = i(w, !0))) : S ? ((z = !1), (E = u(w, !0))) : (E = [])) : v(w) || s(w) ? ((E = j), s(j) ? (E = x(j)) : (h(j) && !d(j)) || (E = a(w))) : (z = !1);
				}
			...
			function o(t) {
				return r(function (e, n) {
					var o = -1,
						...
						u = r > 1 ? n[r - 1] : void 0,
						c = r > 2 ? n[2] : void 0;
					for (u = t.length > 3 && "function" == typeof u ? (r--, u) : void 0, c && i(n[0], n[1], c) && ((u = r < 3 ? void 0 : u), (r = 1)), e = Object(e); ++o < r; ) {
						var a = n[o];
						a && t(e, a, o, u);
					}
					return e;
