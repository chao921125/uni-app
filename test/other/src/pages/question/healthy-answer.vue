<template>
  <view>
    <view class="answer-box">
      <image
        src="https://traceability-1259661131.cos.ap-hongkong.myqcloud.com/page/other-answeryes.png"
        mode="aspectFit"
        class="answer-yes"
        v-if="answer"
      />
      <image
        src="https://traceability-1259661131.cos.ap-hongkong.myqcloud.com/page/answer-no.png"
        mode="aspectFit"
        class="answer-no"
        v-else
      />
    ...
    <view class="answer-count">
      <image
        src="https://traceability-1259661131.cos.ap-hongkong.myqcloud.com/page/other-answercount.png"
        mode="aspectFit"
      />
    </view>
    ...
    <view class="article-box">
      ...
      <image
        ...
        src="https://traceability-1259661131.cos.ap-hongkong.myqcloud.com/page/question-article2.png"
        mode="aspectFit"
        @tap="goDetail"
      />
    </view>
