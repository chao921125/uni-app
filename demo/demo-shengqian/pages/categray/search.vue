<template>
	<view class="index-content">
		...
		<view class="index-coupon has-bg-white has-pd-10" style="padding-top: 90upx" v-if="fromTabIndex==0">
		...
		<view class="index-coupon has-bg-white has-pd-10" style="padding-top: 90upx" v-if="fromTabIndex==1">
		...
		<view class="index-coupon has-bg-white has-pd-10" style="padding-top: 90upx" v-if="fromTabIndex==2">
