...
export function orderStatusAuction(type) {
  ...
  try {
    ...
    if (!type) return '';
    switch (type) {
      case '1': result = 'BIDING'; break;
      case '2': result = 'BID'; break;
      case '3': result = 'OUTBID'; break;
      case '6': result = 'FAIL'; break;
      default: result = 'FINISH'; break;
    }
    return result;
  } catch (e) {
    return result;
...
export function orderStatus(type) {
  ...
  try {
    ...
    if (!type) return '';
    switch (type) {
      case '1': result = 'UNPAID'; break;
      case '3': result = 'CLOSED'; break;
      case '4': result = 'PAID'; break;
      case '5': result = 'SOLD OUT'; break;
      case '7': result = 'IN TRADE'; break;
...
export function orderType(type) {
  ...
  try {
    ...
    if (!type) return '';
    switch (type) {
      case '1': result = 'DROPS'; break;
      case '2': result = 'LEGENDS X'; break;
      case '3': result = 'AUCTION'; break;
      case '4': result = 'DROPS'; break;
      case '5': result = 'SOLD'; break;
      default: result = ''; break;
    }
    return result;
  } catch (e) {
...
export function formatPayMethod(type) {
  ...
  try {
    ...
    if (!type) return '';
    switch (type) {
      case '1': result = 'CREDIT CARD'; break;
      case '2': result = 'CRYPTO'; break;
      case '3': result = 'BALANCE'; break;
      default: result = ''; break;
    }
    return result;
  } catch (e) {
...
export function validatePwd(val) {
  if (val === 'null' || val === 'undefined' || val === '' || !val) return false;
  val = val.trim();
  if (/[a-zA-Z]+/ig.test(val) && /\d+/ig.test(val)) {
    return true;
  }
  return false;
}
...
const mUlr = [
  ...
  'pages/unbox/box-list',
  'pages/unbox/box-detail',
  'pages/unbox/sale-detail',
  'pages/showroom/room-home',
  'pages/showroom/room-detail',
  'pages/showroom/num-detail',
  'pages/showroom/drops-detail'
];
