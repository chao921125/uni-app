<template>
	<view class="lime-echart" :style="[customStyle]" v-if="canvasId" ref="limeEchart" :aria-label="ariaLabel">
		...
		<canvas
			...
			@touchmove="touchMove"
			@touchend="touchEnd" />
		<view class="lime-echart__mask" v-if="isPC" @mousedown="touchStart" @mousemove="touchMove" @mouseup="touchEnd" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd"> </view>
